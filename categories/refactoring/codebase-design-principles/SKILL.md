---
name: codebase-design-principles
description: "Design deep modules with a shared vocabulary of module, interface, depth, seam, and adapter for more leverage, locality, and testability."
license: MIT
tags:
- architecture
- modules
