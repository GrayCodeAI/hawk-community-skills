...
description: "Use when modernizing legacy systems via strangler fig, incremental migration, monolith decomposition, or framework upgrades while preserving business behavior with characterization tests."
license: MIT
tags:
- legacy
- migration
