...
description: "Design deep modules (small interface, lots of behavior) at clean seams; use when improving a module's interface, deciding where a seam goes, or making code more testable."
license: Apache-2.0
tags:
- module-design
- interface-design
