...
description: "Use when reviewing pull requests or conducting code quality audits to identify bugs, security vulnerabilities, code smells, N+1 queries, and architectural concerns with prioritized feedback."
license: MIT
tags:
- code-review
- pull-request
