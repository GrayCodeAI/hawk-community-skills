---
name: diff-scoped-simplification
description: "Apply diff-scoped simplifications using reuse, ownership, efficiency, and test-value checks; use when asked to tidy or simplify a diff."
license: MIT
tags:
- refactoring
- cleanup
