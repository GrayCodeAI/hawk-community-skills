---
name: network-protocol-internals
description: "Use when working with network protocol internals: TCP state machine and congestion control algorithms like CUBIC and BBR."
license: MIT
tags:
- networking
- tcp
