---
name: ebpf-packet-processing
description: "Use when implementing eBPF-based networking: XDP packet processing, Cilium architecture, and kernel-space packet paths."
license: MIT
tags:
- networking
- ebpf
