...
description: "Design and deploy a global external application load balancer with CDN, WAF, and service extensions through a structured discovery flow, generating Terraform or CLI scripts and detecting drift."
license: Apache-2.0
tags:
- load-balancing
- cdn
