---
name: kubernetes-service-networking
description: "Expose applications on Kubernetes securely via Gateway API, standard Ingress, Cloud Armor WAF, container-native load balancing, Private Service Connect, and managed SSL certificates."
license: Apache-2.0
tags:
- kubernetes
- gateway-api
