...
description: "Implement navigation and routing in an Expo Router app with file-based routes, groups, dynamic routes, native stacks, tabs, modals, sheets, links, and header search bars."
license: MIT
tags:
- navigation
- routing
