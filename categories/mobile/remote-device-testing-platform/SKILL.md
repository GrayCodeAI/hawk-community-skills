...
description: "Reserves and manages remote Android devices for testing, including establishing ADB connection tunnels, checking session status, viewing device screens, and extending or cancelling device leases."
license: Apache-2.0
tags:
- mobile
- android
