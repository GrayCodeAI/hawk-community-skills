---
name: dart-flutter-development
description: "Use when building cross-platform Flutter UIs with Dart, covering widgets, state management, isolates, and event loop concurrency."
license: MIT
tags:
- dart
- flutter
