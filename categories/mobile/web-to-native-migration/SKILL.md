---
name: web-to-native-migration
description: "Migrate an existing web React app to a native iOS and Android app, strangling screens into native incrementally while shipping a webview shell on day one."
license: MIT
tags:
- migration
- react-native
