---
name: mobile-app-animations
description: "Build animations in React Native and Expo with Reanimated and Gesture Handler, deciding what animates, which thread, properties, springs, gestures, and haptics."
license: MIT
tags:
- animation
- react-native
