---
name: native-module-development
description: "Build or modify native modules and views for an Expo app using the Expo Modules API across Swift, Kotlin, and TypeScript, including config plugins and lifecycle hooks."
license: MIT
tags:
- native-modules
- swift
