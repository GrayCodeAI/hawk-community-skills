---
name: mobile-engineer-persona
description: "Use to adopt a Staff Mobile Engineer persona for performance, offline-first architecture, battery and memory paranoia, and resilience."
license: MIT
tags:
- mobile
- performance
