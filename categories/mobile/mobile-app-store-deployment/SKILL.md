...
description: "Deploy Expo apps to the iOS App Store, Google Play, and TestFlight with EAS, configuring build and submit profiles, versions, and store metadata."
license: MIT
tags:
- mobile
- deployment
