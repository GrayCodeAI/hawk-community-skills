---
name: flutter-state-management-optimization
description: "Use when optimizing Flutter apps, focusing on state management with Riverpod/BLoC and render tree performance."
license: MIT
tags:
- flutter
- state-management
