...
description: "Control an iOS emulator/simulator stream with taps, gestures, typing, hardware buttons, camera injection, permissions, and accessibility tree from an agent."
license: MIT
tags:
- emulator
- simulator
