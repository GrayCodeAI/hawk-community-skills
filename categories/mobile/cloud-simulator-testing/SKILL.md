---
name: cloud-simulator-testing
description: "Run and control an app on a remote cloud iOS or Android simulator when no local simulator exists, including installing builds, tapping, screenshots, and live-reload testing."
license: MIT
tags:
- simulator
- cloud
