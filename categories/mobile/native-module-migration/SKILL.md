---
name: native-module-migration
description: "Migrate an existing Apple Swift native module from the Expo Modules API 1.0 definition DSL to the 2.0 macro API while preserving its JavaScript and TypeScript contract."
license: MIT
tags:
- native-modules
- swift
