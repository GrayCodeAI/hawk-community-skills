---
name: webview-dom-components
description: "Run web code verbatim in a webview on native platforms using DOM components, enabling web-only libraries, complex HTML/CSS, and incremental web-to-native migration."
license: MIT
tags:
- dom-components
- webview
