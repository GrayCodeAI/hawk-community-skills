---
name: mobile-dev-client-builds
description: "Build and distribute Expo development clients locally or via TestFlight for testing native code changes on physical devices, configuring EAS development profiles."
license: MIT
tags:
- mobile
- ios
