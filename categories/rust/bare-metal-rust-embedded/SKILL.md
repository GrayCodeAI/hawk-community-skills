---
name: bare-metal-rust-embedded
description: "Develop bare-metal Rust for embedded systems (ARM Cortex-M, RISC-V) with no_std, PAC/HAL crates, and compile-time memory safety."
license: MIT
tags:
- rust
- embedded
