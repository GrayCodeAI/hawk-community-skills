---
name: secure-desktop-app-development
description: "Use to build secure cross-platform desktop applications with Tauri, including secure native IPC via commands and Rust core architecture."
license: MIT
tags:
- desktop
- rust
