---
name: idiomatic-rust-development
description: "Use when writing, reviewing, or debugging idiomatic Rust — ownership, lifetimes, traits, async with tokio, and Result/Option error handling with memory safety."
license: MIT
tags:
- rust
- memory-safety
