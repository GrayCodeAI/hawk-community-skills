---
name: angular-development-guidance
description: "Generates Angular code and guidance for components, signals, forms, dependency injection, routing, SSR, accessibility, and testing."
license: MIT
tags:
- angular
- components
...
2. Use Signal Forms for form management in new projects (stable in Angular v22 and newer) Find out more.
...
- **Fundamentals**: Anatomy, metadata, core concepts, self-closing tags, and template control flow (@if, @for, @switch). Read components.md
...
- **Naming Conventions**: Modern Angular v20+ naming style ("Intent over Role") for files, components, services, directives, pipes, and models. Read naming-conventions.md
