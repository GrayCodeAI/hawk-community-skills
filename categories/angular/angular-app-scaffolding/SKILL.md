---
name: angular-app-scaffolding
description: "Creates new Angular applications using the Angular CLI, following modern best practices for structure, routing, and styling."
license: MIT
tags:
- angular
- scaffolding
