---
name: error-display-troubleshooting
description: "Use when showing a failed API request or query error in the UI, adding troubleshooting steps for a new error type, or wiring an AI debug action from an error state."
license: Apache-2.0
tags:
- error-handling
- ui
