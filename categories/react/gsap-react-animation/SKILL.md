---
name: gsap-react-animation
description: "Animate React and Next.js components with GSAP using the useGSAP hook, refs, scoped selectors, and cleanup on unmount."
license: MIT
tags:
- animation
- react
