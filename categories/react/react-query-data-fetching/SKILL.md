...
description: "Use when writing or reviewing React Query hooks, mutation hooks, or query keys for data fetching — adding the first fetch or mutation for a new API endpoint or resource."
license: Apache-2.0
tags:
- react-query
- data-fetching
