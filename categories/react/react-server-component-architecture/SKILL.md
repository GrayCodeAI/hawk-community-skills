---
name: react-server-component-architecture
description: "Use when working with Next.js App Router internals: React Server Components, client boundaries, and streaming SSR."
license: MIT
tags:
- react
- nextjs
