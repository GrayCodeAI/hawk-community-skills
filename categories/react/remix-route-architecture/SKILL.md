---
name: remix-route-architecture
description: "Use when building Remix applications with file-based routing, server loaders/actions, sessions, and per-runtime deployment."
license: MIT
tags:
- react
- remix
