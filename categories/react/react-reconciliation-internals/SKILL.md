---
name: react-reconciliation-internals
description: "Use when working with React Fiber internals: reconciliation, render/commit phases, and concurrent scheduling."
license: MIT
tags:
- react
- fiber
