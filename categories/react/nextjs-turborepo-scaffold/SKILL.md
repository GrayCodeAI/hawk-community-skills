---
name: nextjs-turborepo-scaffold
description: "Scaffold a Next.js turborepo with tooling, GitHub, and deployment setup; use when asked to create a Next.js project or bootstrap a monorepo."
license: MIT
tags:
- nextjs
- react
