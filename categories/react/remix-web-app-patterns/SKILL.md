---
name: remix-web-app-patterns
description: "Use when applying production Remix patterns: server-side validation, error boundaries, SEO metadata, caching, and optimistic UI."
license: MIT
tags:
- react
- remix
