---
name: react-server-component-rendering
description: "Use when building React apps with server components, deciding RSC vs SSR, or streaming server-rendered UI without shipping component code to the client."
license: MIT
tags:
- react
- server-components
