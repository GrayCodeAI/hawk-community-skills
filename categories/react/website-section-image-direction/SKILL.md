---
name: website-section-image-direction
description: "Generate one premium horizontal image per website section as implementation references; use for landing pages and marketing sites."
license: MIT
tags:
- frontend
- design
