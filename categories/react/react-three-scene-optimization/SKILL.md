---
name: react-three-scene-optimization
description: "Write and optimize React Three Fiber 3D scenes: performance and re-renders, useFrame, Drei helpers, state, post-processing, and physics."
license: MIT
tags:
- three-d
- react
