---
name: react-physics-animation
description: "Add natural physics-based motion to React UIs with spring hooks, gestures, transitions, trails, and velocity-preserving interruptible animations."
license: MIT
tags:
- react
- animation
