---
name: anti-slop-frontend-design
description: "Read the brief, infer design direction, and ship interfaces that do not look templated; use for landing pages, portfolios, and redesigns."
license: MIT
tags:
- frontend
- design
