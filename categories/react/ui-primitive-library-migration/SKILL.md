---
name: ui-primitive-library-migration
description: "Use when asked to migrate React projects or components from one UI primitive library to another, converting primitives for single components or whole projects."
license: MIT
tags:
- react
- migration
