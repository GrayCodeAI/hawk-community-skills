...
description: "Use before writing or modifying any form code — data flow, subscriptions, reset, dirty state, number inputs, and controlled-input rules — to avoid common anti-patterns."
license: Apache-2.0
tags:
- forms
- react
