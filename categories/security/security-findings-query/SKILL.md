---
name: security-findings-query
description: "Queries and retrieves active security findings, external exposures, toxic combinations, vulnerabilities, and threats from a cloud security command center for triage and validation."
license: Apache-2.0
tags:
- security
- findings
...
See finding_schema.md for the JSON structure of
