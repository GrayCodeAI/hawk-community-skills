---
name: offensive-security-methodology
description: "Use when applying offensive security methodology: cyber kill chain, MITRE ATT&CK mapping, OSINT, and privilege escalation theory."
license: MIT
tags:
- security
- penetration-testing
...
flowchart TD
    A[OSINT & Reconnaissance] --> B[Target Surface Mapping]
    B --> C[Weaponization Strategy]
    C --> D[Delivery Mechanisms]
    D --> E[Exploitation of Vulnerability]
    E --> F[Installation & Persistence]
    F --> G[Command & Control Setup]
    G --> H[Internal Recon & Lateral Movement]
    H --> I[Privilege Escalation Mapping]
    I --> J[Actions on Objectives]
```
