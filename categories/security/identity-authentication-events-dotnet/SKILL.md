---
name: identity-authentication-events-dotnet
description: "Handle custom identity authentication events in .NET functions for token enrichment, custom claims, and OTP delivery."
license: MIT
tags:
- authentication
- identity
