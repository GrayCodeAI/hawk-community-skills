---
name: key-vault-cryptographic-keys
description: "Create, rotate, and use cryptographic keys with encrypt, decrypt, sign, and wrap operations from the key vault keys SDK."
license: MIT
tags:
- cryptography
- key-management
