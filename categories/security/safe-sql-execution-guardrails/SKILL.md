---
name: safe-sql-execution-guardrails
description: "Use whenever code will build, return, fetch, or execute SQL against a user's real database — even when the task reads as an ordinary feature or bug fix."
license: Apache-2.0
tags:
- sql
- security
