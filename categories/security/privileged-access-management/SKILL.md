...
description: "Manages on-demand temporary privileged access: create, update, and delete entitlements, request time-bound grants, and approve or deny pending requests."
license: Apache-2.0
tags:
- iam
- security
