...
def isolate_host_crowdstrike(api_base, api_token, device_id):
    ...
    resp = requests.post(
        f"{api_base}/devices/entities/devices-actions/v2",
...
def generate_containment_checklist(incident_type):
    ...
    checklists = {
        "ransomware": [
            ...
            {
                "step": 4,
                "action": "Preserve forensic evidence before reimaging",
                "priority": "HIGH",
            },
            {"step": 5, "action": "Reset Kerberos KRBTGT password twice", "priority": "HIGH"},
            {
                "step": 6,
                "action": "Revoke active VPN and remote access sessions",
                "priority": "HIGH",
            },
        ...
        "data_breach": [
            ...
            {
                "step": 3,
                "action": "Block external IPs involved in exfiltration",
                "priority": "HIGH",
            },
            ...
            {
                "step": 6,
                "action": "Engage legal for breach notification requirements",
                "priority": "MEDIUM",
            },
        ],
        "account_compromise": [
            {
                "step": 1,
                "action": "Disable compromised accounts immediately",
                "priority": "CRITICAL",
            },
            ...
            {
                "step": 4,
                "action": "Review recent account activity and access logs",
                "priority": "HIGH",
            },
            {
                "step": 5,
                "action": "Check for persistence mechanisms (forwarding rules, OAuth apps)",
                "priority": "HIGH",
            },
        ],
    }
...
def run_containment(incident_type="ransomware"):
    ...
    print(f"\n{'=' * 60}")
    print("  ACTIVE BREACH CONTAINMENT")
...
def main():
    ...
    parser.add_argument(
        "--incident-type",
        choices=["ransomware", "data_breach", "account_compromise"],
        default="ransomware",
