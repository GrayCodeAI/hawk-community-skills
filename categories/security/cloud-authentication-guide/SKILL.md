---
name: cloud-authentication-guide
description: "Provides guidance on authenticating and authorizing to cloud services and APIs, covering human users, service accounts, Application Default Credentials, federation, and secure access best practices."
license: Apache-2.0
tags:
- security
- authentication
...
use keys. Instead, use Workload Identity Fedration tz**: Grant that Service Account the `roles/cloudsql.client` role on
    the project.
