---
name: code-ownership-risk-analysis
description: "Analyze git history to build a people-to-file security ownership topology, compute bus factor and sensitive-code ownership, and export graphs."
license: MIT
tags:
- security
- git
