---
name: incident-response-query-language
description: "Compose incident response hunting pipelines with selector, extractor, and enricher functions to investigate security events."
license: MIT
tags:
- threat-hunting
- security
