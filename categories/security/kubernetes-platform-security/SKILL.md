...
description: "Plans, configures, and hardens platform-level Kubernetes cluster security covering RBAC hardening, Binary Authorization, Shielded Nodes, GKE Sandbox, and IAM roles."
license: Apache-2.0
tags:
- kubernetes
- gke
