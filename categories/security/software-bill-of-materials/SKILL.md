...
description: "Generate and manage SBOMs (CycloneDX/SPDX) with vulnerability correlation, license compliance, and attestation signing for supply chain security."
license: MIT
tags:
- sbom
- supply-chain
