---
name: cloud-attack-path-analysis
description: "Use when analyzing cloud attack vectors: IAM privilege escalation, metadata service abuse, and serverless exploitation (educational)."
license: MIT
tags:
- security
- cloud
