---
name: cloud-credential-authentication
description: "Authenticate Python apps to cloud services using DefaultAzureCredential, managed identity, service principals, and token caching."
license: MIT
tags:
- authentication
- credentials
