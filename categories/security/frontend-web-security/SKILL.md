---
name: frontend-web-security
description: "Use when preventing XSS, CSRF, and injection with CSP, SRI, secure cookies, and output encoding in frontend apps."
license: MIT
tags:
- security
- xss
...
| `Strict-Transport-Security` | `max-age=64672000; includeSubDomains` | Enforces HTTPS |
