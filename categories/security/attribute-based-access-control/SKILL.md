...
description: "Implement fine-grained attribute-based access control with policies (OPA/Rego, XACML) evaluating subject, resource, action, and environment attributes."
license: MIT
tags:
- access-control
- authorization
