---
name: query-result-graph-visualization
description: "Turn KQL or IRQL query results into icon-decorated, interactive graphs for Kusto Explorer using lift, render, and fold functions."
license: MIT
tags:
- graph-visualization
- security
