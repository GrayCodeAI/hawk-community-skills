...
class SQLiteForensicsAgent:
    ...
    def analyze_freelist(self):
        ...
        return {"freelist_pages": total_free, "trunk_pages": trunk_pages, "leaf_pages": leaf_pages}
    ...
    def parse_wal(self):
        ...
        with open(wal_path, "rb") as f:
            ...
            while offset + 24 + page_size <= file_size:
                ...
                frames.append({"frame": frame_num, "page": page_number, "offset": offset})
                offset += 24 + page_size
                frame_num += 1
    ...
    def decode_timestamp(value, fmt="unix"):
        ...
        try:
            if fmt == "unix":
                ...
                return datetime.utcfromtimestamp((value / 1_000_000) - epoch_delta).isoformat()
