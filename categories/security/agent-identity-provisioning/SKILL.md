---
name: agent-identity-provisioning
description: "Create OAuth2-capable identities for AI agents via a Graph API, including blueprints, principals, and workload identity federation."
license: MIT
tags:
- identity
- agents
