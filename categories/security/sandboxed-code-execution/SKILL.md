...
description: "Use when designing sandboxed execution environments for agents with microVM isolation, snapshotting, resource quotas, and durable execution."
license: MIT
tags:
- sandbox
- isolation
...
- Sandbox-as-a-Tool Pattern — Architecture for exposing sandboxes as composable agent tools
- Durable Execution Frameworks — Temporal, Restate, and durable execution patterns
- MicroVM Isolation — gVisor, Kata Containers, and Firecracker deep dive
- Workspace Isolation — Isolated workspace provisioning and management
- State Persistence & Snapshots — Snapshotting, forking, and state restoration
- Filesystem Sandboxing — Filesystem isolation, overlay mounts, and access policies
- Network Isolation Policies — Network segmentation and egress control
- Resource Quota Enforcement — CPU, memory, disk, and PID quota enforcement
