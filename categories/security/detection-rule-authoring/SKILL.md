---
name: detection-rule-authoring
description: "Write high-fidelity SIEM/EDR detection rules (Sigma, SPL, KQL) mapped to MITRE ATT&CK, with alert tuning and false-positive reduction."
license: MIT
tags:
- detection
- siem
