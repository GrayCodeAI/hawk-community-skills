...
description: "Build a security scanning pipeline with SAST and DAST tools, custom rules, authenticated sessions, false positive triage, and CI gate configuration."
license: MIT
tags:
- sast
- dast
