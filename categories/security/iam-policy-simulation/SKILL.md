...
description: "Safely simulates and applies identity and access management allow-policy changes by replaying historical access logs against proposed policies to prevent breaking active workloads."
license: Apache-2.0
tags:
- security
- iam
