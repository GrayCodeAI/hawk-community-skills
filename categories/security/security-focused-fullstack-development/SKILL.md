---
name: security-focused-fullstack-development
description: "Use when implementing features across frontend and backend with layered security — auth, input validation, output encoding, and parameterized queries at every stack level."
license: MIT
tags:
- fullstack
- security
