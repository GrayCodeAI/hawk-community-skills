...
description: "Use when designing SIEM architecture, onboarding log sources, creating correlation rules, and tuning detection."
license: MIT
tags:
- siem
- security
...
index=windows EventCode=4646 (LogonType=3 OR LogonType=10)
...
| P1 | Lateral movement via RDP | Windows Event 4646 | T1021.001 | Statistical |
...
| P2 | Service account interactive login | Windows Event 4646 | T1078 | Anomaly |
...
| P3 | Out-of-hours access | Windows Event 4646 | T1078 | Time-based |
