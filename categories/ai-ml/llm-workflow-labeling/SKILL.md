---
name: llm-workflow-labeling
description: "Find and label every LLM workflow in a repository so spend groups by workflow; use for 'discover workflows' or breaking LLM spend down."
license: MIT
tags:
- llm
- workflow
