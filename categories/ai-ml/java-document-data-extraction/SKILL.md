---
name: java-document-data-extraction
description: "Extract text, tables, and structured fields from invoices, receipts, and IDs in Java with prebuilt and custom document models."
license: MIT
tags:
- ocr
- document-extraction
