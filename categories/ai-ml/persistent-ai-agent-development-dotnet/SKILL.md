---
name: persistent-ai-agent-development-dotnet
description: "Create and manage persistent AI agents in .NET with threads, messages, runs, streaming, function calling, and file search."
license: MIT
tags:
- ai
- agents
