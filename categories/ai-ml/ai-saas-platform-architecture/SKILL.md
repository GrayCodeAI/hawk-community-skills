---
name: ai-saas-platform-architecture
description: "Use as a playbook for building a full-stack AI SaaS platform integrating LLM orchestration, event-driven messaging, and subscription billing."
license: MIT
tags:
- ai
- saas
