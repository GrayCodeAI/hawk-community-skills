...
description: "Generate video clips from reference images, videos, and audio via CLI, binding them as numbered references for character and scene consistency across a 2-30 second shot."
license: MIT
tags:
- ai-ml
- video-generation
