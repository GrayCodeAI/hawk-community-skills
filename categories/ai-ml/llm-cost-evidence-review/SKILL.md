---
name: llm-cost-evidence-review
description: "Read-only review of LLM spend, token usage, and savings evidence; use when asked what a monitoring tool found or where spend goes."
license: MIT
tags:
- llm
- cost
