---
name: image-editing-router
description: "Route image-edit requests to the right model via CLI, covering batch identity-preserving edits, multilingual in-image text rewrite, precise local edits, and mask-driven inpainting."
license: MIT
tags:
- ai-ml
- image-editing
