---
name: anomaly-model-integration
description: "Adds new anomaly detection model architectures to a library, wiring them into the base module and registering them."
license: Apache-2.0
tags:
- anomaly-detection
- ai-ml
