...
description: "Use to generate full songs and instrumental tracks from a text description with ElevenLabs Music, including structured lyrics and section control."
license: MIT
tags:
- music
- song
