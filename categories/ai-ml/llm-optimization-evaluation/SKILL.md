...
description: "Turn an LLM optimization observation into an operator-chosen candidate with paired baseline evaluation; use to inspect optimization reports."
license: MIT
tags:
- llm
- optimization
