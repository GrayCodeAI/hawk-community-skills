---
name: llm-api-integration-dotnet
description: "Build .NET apps using LLM APIs for chat completions, embeddings, image generation, audio transcription, and assistants with structured outputs."
license: MIT
tags:
- llm
- ai
