---
name: ai-agent-project-development
description: "Create AI agents, manage connections, deployments, datasets, and indexes, and run model responses via the projects client."
license: MIT
tags:
- ai-agents
- model-deployments
