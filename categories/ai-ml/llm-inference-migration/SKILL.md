---
name: llm-inference-migration
description: "Migrate existing AI inference workloads from serverless or API platforms to self-hosted Kubernetes inference, covering hardware sizing, model staging, manifest generation, validation, and cutover."
license: Apache-2.0
tags:
- llm
- inference
