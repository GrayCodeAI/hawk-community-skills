---
name: agent-interactions-api
description: "Guides using the stateful, server-managed Interactions API for multi-turn agent conversations, background execution, streaming, structured output, and function calling on an agent platform."
license: Apache-2.0
tags:
- generative-ai
- agents
...
> Models Only**: Use `geini-3.5-flash` (fast,ect/base-model
