...
description: "Generate videos from prompt or still across a full model catalog, routing to the right text-to-video, image-to-video, or extend model for the user's intent."
license: MIT
tags:
- video
- generation
