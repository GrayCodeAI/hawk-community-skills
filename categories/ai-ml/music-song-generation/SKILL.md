---
name: music-song-generation
description: "Generate full songs and instrumental tracks from a style brief plus structured lyrics with section markers, from short jingles to five-minute vocal tracks."
license: MIT
tags:
- music
- audio
