---
name: desktop-pet-sprite-generator
description: "Generate a custom animated desktop pet sprite atlas (pet.json + spritesheet.webp) from one reference image for a coding assistant."
license: MIT
tags:
- image-generation
- pixel-art
