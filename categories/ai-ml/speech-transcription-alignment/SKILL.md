---
name: speech-transcription-alignment
description: "Transcribe audio to text with speaker diarization, event tagging, word-level timestamps, and forced alignment for subtitles."
license: MIT
tags:
- speech-to-text
- transcription
