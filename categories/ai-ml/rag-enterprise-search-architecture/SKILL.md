---
name: rag-enterprise-search-architecture
description: "Designs a RAG-capable enterprise search system using a vector-enabled SQL database, an open model and inferencing framework, and Kubernetes hosting, covering architecture, design, and deployment."
license: Apache-2.0
tags:
- rag
- search
