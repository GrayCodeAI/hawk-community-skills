---
name: multi-agent-topology-architecture
description: "Use when architecting multi-agent interaction topologies such as supervisor-worker, pipelines, and debate swarms."
license: MIT
tags:
- multi-agent
- topology
