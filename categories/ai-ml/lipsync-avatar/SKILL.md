---
name: lipsync-avatar
description: "Drive a face's mouth from an audio track, routing across avatar, mouth-swap, and script-based lip-sync models for dubbed video and voiceover sync."
license: MIT
tags:
- video
- lipsync
