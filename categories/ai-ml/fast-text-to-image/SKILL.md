...
description: "Generate images from text with a fast, distilled text-to-image model via CLI, using subject-first prompts and step-count strategies for rapid creative iteration."
license: MIT
tags:
- image-generation
- text-to-image
