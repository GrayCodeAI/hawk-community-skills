---
name: realtime-model-client
description: "Generates a realtime bidirectional streaming client service class for a model websocket endpoint with session resumption, token refresh, and message exchange."
license: Apache-2.0
tags:
- ai
- websocket
