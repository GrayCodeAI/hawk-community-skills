---
name: pull-request-video-creation
description: "Turn a GitHub pull request into a code-change explainer video built from its diff, commits, and files."
license: Apache-2.0
tags:
- video
- video-generation
...
| `media-use/audio/references/tts.md`                                                                              | Step 3.1: choose or understand TTS providers.                                                            |
...
| `hyperframes-creative/frame-presets/code-editorial/FRAME.md`                            | Step 2: the code-editorial preset (fixed style).                                                         |
