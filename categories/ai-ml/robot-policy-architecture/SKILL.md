---
name: robot-policy-architecture
description: "Adds new robot policy families to a training library with the config/model/policy split and factory registration."
license: Apache-2.0
tags:
- robotics
- ai-ml
