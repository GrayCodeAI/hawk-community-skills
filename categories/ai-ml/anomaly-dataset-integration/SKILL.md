---
name: anomaly-dataset-integration
description: "Adds new datasets and datamodules to an anomaly detection library, wiring them into base classes and registering them."
license: Apache-2.0
tags:
- anomaly-detection
- datasets
