...
description: "Use when building, debugging, or extending servers and clients that connect AI systems to external tools and data via the Model Context Protocol with schema-validated tool handlers."
license: MIT
tags:
- mcp
- ai-tools
