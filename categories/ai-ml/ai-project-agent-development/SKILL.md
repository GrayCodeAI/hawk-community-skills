---
name: ai-project-agent-development
description: "Build AI applications with project clients, creating versioned agents, running evaluations, and managing connections and deployments."
license: MIT
tags:
- ai
- agents
