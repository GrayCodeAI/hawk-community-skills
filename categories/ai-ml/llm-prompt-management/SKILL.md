...
description: "Create, list, retrieve, version, and delete managed prompts for LLM applications via an SDK, with safety confirmation tiers for mutating and destructive operations."
license: Apache-2.0
tags:
- prompts
- llm
...
*   **Reference**: See create.md for detailed
