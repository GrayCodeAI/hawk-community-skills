---
name: ai-agent-alerting-policies
description: "Configures best-practice alerting policies for AI agents using telemetry metrics, generating Terraform for latency, error rate, token usage, and quality."
license: Apache-2.0
tags:
- ai
- monitoring
