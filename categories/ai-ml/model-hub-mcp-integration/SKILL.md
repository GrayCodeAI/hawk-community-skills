---
name: model-hub-mcp-integration
description: "Uses model-hub MCP server tools to search models, datasets, Spaces, and papers, fetch repo details and docs, run GPU/CPU compute jobs, and use Gradio Spaces as AI tools."
license: Apache-2.0
tags:
- model-hub
- mcp
