...
description: "Analyze conversation intent and entities in Python using the language conversations client; use when building conversational understanding or NLP features."
license: MIT
tags:
- conversation
- nlp
