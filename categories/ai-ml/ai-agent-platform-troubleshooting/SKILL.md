---
name: ai-agent-platform-troubleshooting
description: "Diagnoses AI agent platform issues including gateway, registry, identity, policies, and authorization errors, producing evidence-based fix recommendations."
license: Apache-2.0
tags:
- ai
- agents
