---
name: video-canvas-extension
description: "Extend a video's spatial canvas to change aspect ratio or uncrop, adding matching environment while preserving central action and original framing."
license: MIT
tags:
- video
- outpainting
