...
description: "Generate video from text prompts with synchronized audio and multi-shot character consistency; describe motion over time and camera direction for best results."
license: MIT
tags:
- video-generation
- text-to-video
