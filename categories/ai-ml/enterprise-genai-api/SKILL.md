---
name: enterprise-genai-api
description: "Guides using the Gemini API in an enterprise agent platform with the unified Gen AI SDK across languages, covering multimodal input, tools, media generation, caching, and Live API."
license: Apache-2.0
tags:
- generative-ai
- llm
