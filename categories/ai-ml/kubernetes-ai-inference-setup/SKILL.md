---
name: kubernetes-ai-inference-setup
description: "Set up AI model serving on Kubernetes: install controller, assess GPU, choose inference provider, and deploy models."
license: MIT
tags:
- kubernetes
- ai-inference
