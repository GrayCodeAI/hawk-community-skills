---
name: time-series-anomaly-detection-azure-ai-anomalydetector-java
description: "Detect anomalies in univariate and multivariate time-series data with the Java Anomaly Detector SDK."
license: MIT
tags:
- anomaly-detection
- time-series
