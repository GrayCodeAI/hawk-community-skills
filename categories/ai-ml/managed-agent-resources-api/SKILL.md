---
name: managed-agent-resources-api
description: "Manages stateful, server-managed agent resources programmatically: create, configure, list, update, and delete agents with mounted files, skills, and tools."
license: Apache-2.0
tags:
- ai
- agents
