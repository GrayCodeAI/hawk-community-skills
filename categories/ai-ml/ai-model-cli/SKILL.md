---
name: ai-model-cli
description: "Install, authenticate, and invoke hundreds of AI model endpoints from a single CLI, covering image and video generation, editing, lip-sync, inpainting, and LoRA training with polling and scripting."
license: MIT
tags:
- cli
- ai-ml
