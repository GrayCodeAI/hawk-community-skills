---
name: ai-foundry-project-management-dotnet
description: "Manage AI platform projects in .NET including agents, connections, datasets, deployments, evaluations, and indexes."
license: MIT
tags:
- ai
- agents
