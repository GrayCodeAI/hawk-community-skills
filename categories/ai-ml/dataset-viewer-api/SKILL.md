---
name: dataset-viewer-api
description: "Explore and extract data from Hub datasets using the read-only Viewer API: list splits, paginate rows, search text, filter, and fetch parquet URLs."
license: Apache-2.0
tags:
- datasets
- api
