---
name: text-to-video-generation-prime-skills
description: "Use to generate text-to-video with HappyHorse 1.0, which produces native 1080p in-pass audio and multi-shot character consistency."
license: MIT
tags:
- video-generation
- text-to-video
