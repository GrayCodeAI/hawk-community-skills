---
name: edge-ai-app-orchestration
description: "Turns a plain business objective into a working Intel Edge AI application by asking business questions and delegating to skills."
license: Apache-2.0
tags:
- orchestration
- ai-ml
...
| File | Load when |
|---|---|
| `references/SKILL_CATALOG.md` | Mapping a business objective → the delegate skill(s). Load in Step 2 (Discover). |
...
- The delegate that builds the end-to-end vision stack is
  ...
  `open-edge-platform/skills`.
- Keep the catalog in `references/SKILL_CATALOG.md`
