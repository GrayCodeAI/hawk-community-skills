---
name: text-to-video
description: "Generate text-to-video clips with multi-reference conditioning and audio-driven lip-sync from a supplied voiceover track, with duration and aspect control."
license: MIT
tags:
- video
- generation
