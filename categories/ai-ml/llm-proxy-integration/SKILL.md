---
name: llm-proxy-integration
description: "Wire a repository through an LLM proxy gateway so every request is measured with no behavior change; use to set up LLM spend observability."
license: MIT
tags:
- llm
- proxy
