...
description: "Generate and edit images with precise embedded-text, logo, and multilingual typography rendering plus strong instruction following and layout control."
license: MIT
tags:
- image
- generation
