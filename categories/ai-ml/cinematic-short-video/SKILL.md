...
description: "Generate cinematic short-form video with multi-modal references (images, videos, audio) and native lip-synced audio, honoring lens and camera language."
license: MIT
tags:
- video
- generation
