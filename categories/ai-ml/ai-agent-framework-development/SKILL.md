---
name: ai-agent-framework-development
description: "Build persistent AI agents with a hosted provider, using function tools, hosted tools, MCP servers, threads, and streaming."
license: MIT
tags:
- ai
- agents
