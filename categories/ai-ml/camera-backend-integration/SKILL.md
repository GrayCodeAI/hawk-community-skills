---
name: camera-backend-integration
description: "Adds or modifies camera capture backends implementing the Camera interface with discovery and factory registration."
license: Apache-2.0
tags:
- robotics
- camera
