---
name: text-to-speech-audio-narrative
description: "Generate podcast-style audio narratives from text using a realtime speech model over WebSocket, from frontend to backend."
license: MIT
tags:
- audio
- text-to-speech
