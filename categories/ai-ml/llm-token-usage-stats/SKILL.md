---
name: llm-token-usage-stats
description: "Show real token usage and estimated savings for the current session from the session log; use when asked for session stats."
license: MIT
tags:
- llm
- tokens
