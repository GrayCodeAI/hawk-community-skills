---
name: transformer-reinforcement-training
description: "Train and fine-tune transformer language models with TRL: SFT, DPO, GRPO, KTO, RLOO, and reward-model training via CLI, including LoRA adapters and distributed configs."
license: Apache-2.0
tags:
- llm
- fine-tuning
