---
name: anomaly-detection-model-training
description: "Trains an anomaly detection model on a dataset via Python API or CLI, including custom folder-structured datasets."
license: Apache-2.0
tags:
- anomaly-detection
- ai-ml
