---
name: model-serving-endpoint-management
description: "Manages serving endpoints for model deployment: create, list, describe, update, and delete endpoints, handle traffic splitting, and troubleshoot permission, quota, or resource-busy errors."
license: Apache-2.0
tags:
- model-serving
- endpoints
