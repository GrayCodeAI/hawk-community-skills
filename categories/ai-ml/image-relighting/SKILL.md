...
description: "Relight still images through a CLI by changing lighting direction, color temperature, intensity, or mood while preserving subject identity, with fallback to generic edit models."
license: MIT
tags:
- ai-ml
- image-editing
