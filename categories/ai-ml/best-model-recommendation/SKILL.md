---
name: best-model-recommendation
description: "Find and compare the best models for a task using benchmark leaderboards, filtering by device memory and ranking by score into a comparison table."
license: Apache-2.0
tags:
- model-selection
- benchmarks
