---
name: llm-tuning-job-management
description: "List, inspect, and cancel ongoing LLM tuning jobs via an SDK, with explicit typed confirmation required for destructive cancellation."
license: Apache-2.0
tags:
- llm
- tuning
