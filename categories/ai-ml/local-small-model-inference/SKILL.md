---
name: local-small-model-inference
description: "Use when running small language models locally with llama.cpp, GGUF parsing, and KV cache offloading across CPU and GPU."
license: MIT
tags:
- ai
- inference
