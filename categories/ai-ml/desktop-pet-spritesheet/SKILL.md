---
name: desktop-pet-spritesheet
description: "Build an animated desktop-pet sprite atlas (spritesheet plus manifest) from a single reference image, using one AI edit call followed by programmatic animation-row assembly."
license: MIT
tags:
- ai-ml
- pixel-art
