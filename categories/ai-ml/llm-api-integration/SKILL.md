...
description: "Builds LLM-powered applications with an LLM API, covering models, streaming, tool use, agents, caching, and token counting across SDK languages."
license: MIT
tags:
- llm
- api
...
**User-defined tools** - You define tools (via decorators, Zo schemahinking is on by default - unlike Opus 4.8/4.7) | Removed - 400 | Removed - 400 | `low`-`max` (all five) |
