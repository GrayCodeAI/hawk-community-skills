---
name: eval-experiment-lifecycle
description: "Inspect experiment lifecycle and block unsafe execution; use when asked to start, approve, cancel, or roll back an evaluation experiment."
license: MIT
tags:
- experiments
- evaluation
