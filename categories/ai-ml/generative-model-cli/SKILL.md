---
name: generative-model-cli
description: "Install, authenticate, and invoke hundreds of image, video, and audio generation models from the command line via a single CLI."
license: MIT
tags:
- cli
- image-generation
