---
name: robot-policy-loading
description: "Loads and validates robot policies exported for deployment through an inference model with adapter auto-detection."
license: Apache-2.0
tags:
- robotics
- inference
