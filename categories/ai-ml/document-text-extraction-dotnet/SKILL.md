---
name: document-text-extraction-dotnet
description: "Extract text, tables, and structured data from documents in .NET using prebuilt and custom OCR models for invoices, receipts, and IDs."
license: MIT
tags:
- ocr
- document-processing
