---
name: time-series-anomaly-detection-time-series-analytics-user
description: "Builds time-series analytics use cases with UDF and TICKscript pairs for threshold alerting, spike detection, and model inference."
license: Apache-2.0
tags:
- time-series
- anomaly-detection
