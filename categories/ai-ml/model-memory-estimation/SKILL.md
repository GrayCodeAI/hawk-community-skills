---
name: model-memory-estimation
description: "Estimate the memory and VRAM required to run a model for inference from Safetensors or GGUF weights, including optional KV-cache sizing."
license: Apache-2.0
tags:
- memory
- vram
