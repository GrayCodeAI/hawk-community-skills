---
name: multi-agent-swarm-design
description: "Use when designing multi-agent swarms with actor-model isolation, intent routing, and agent debate for distributed AI systems."
license: MIT
tags:
- ai
- agents
