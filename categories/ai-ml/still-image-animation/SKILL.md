...
description: "Animate a single still image into a 4-30 second cinematic clip with optional synchronized native audio, keeping subject and framing anchored to the source."
license: MIT
tags:
- video
- image
