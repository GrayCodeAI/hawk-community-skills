...
description: "Train object detection, image classification, and SAM/SAM2 segmentation models on cloud GPUs, with COCO dataset prep, augmentation, and mAP evaluation."
license: Apache-2.0
tags:
- computer-vision
- object-detection
