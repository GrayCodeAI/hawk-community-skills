---
name: image-region-inpainting
description: "Edit a specific masked region of an image to remove objects, watermarks, or blemishes, with mask-driven or description-based routing by precision needs."
license: MIT
tags:
- image
- inpainting
