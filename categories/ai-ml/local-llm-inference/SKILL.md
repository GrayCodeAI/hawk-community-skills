...
description: "Selects and runs GGUF models locally with llama.cpp on CPU, Mac Metal, CUDA, or ROCm, covering quant selection, server launching, exact GGUF file lookup, and OpenAI-compatible local serving."
license: Apache-2.0
tags:
- llm
- gguf
