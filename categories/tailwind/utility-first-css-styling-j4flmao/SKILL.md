---
name: utility-first-css-styling-j4flmao
description: "Use when styling with Tailwind CSS — utility-first classes, design tokens, responsive variants, and config."
license: MIT
tags:
- tailwind
- css
