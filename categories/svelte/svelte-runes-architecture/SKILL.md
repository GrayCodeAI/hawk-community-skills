---
name: svelte-runes-architecture
description: "Use when structuring Svelte 5 apps with runes ($state, $derived, $effect), compile-time reactivity, and component architecture."
license: MIT
tags:
- svelte
- reactivity
