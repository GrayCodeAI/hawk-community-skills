---
name: codebase-question-answering
description: "Answer questions about a code repository using source file analysis, citing files and explaining how components work."
license: MIT
tags:
- documentation
- codebase
