---
name: skill-catalog-routing
description: "Locates and loads the right product-specific skill on demand from a remote catalog index, matching requests to skill descriptions and fetching entrypoints instead of preloading every skill."
license: Apache-2.0
tags:
- skill-discovery
- catalog
