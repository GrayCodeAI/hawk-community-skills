---
name: walkthrough-report-generation
description: "Use to generate dense, visually striking walkthrough reports of completed work using markdown, alerts, mermaid diagrams, and diff blocks."
license: MIT
tags:
- documentation
- reporting
