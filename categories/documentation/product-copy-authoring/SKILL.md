---
name: product-copy-authoring
description: "Writes, extracts, edits, revoices, critiques, and audits copy for brand, editorial, product, UX, and conversion surfaces."
license: MIT
tags:
- copywriting
- content
...
- **write** ("write the headline", "new copy from this brief", "we need a value proposition") → write.md
- **extract** ("structure this page", "pull the copy from this URL", "turn this brief into copy.yaml") → extract.md
- **refresh** ("tighten this", "the copy reads weak", "polish before handoff") → refresh.md
- **revoice** ("make it playful", "make it sound premium", "drier, less salesy") → revoice.md
- **reconcile** ("sync copy from code", "the implementation drifted") → reconcile.md

**Judge** — a non-mutating verdict on existing copy:

- **critique** ("does this read as slop", "score the copy", "verdict before more editing") → critique.md
- **audit** ("is this copy ready to ship", "defect report before handoff") → audit.md
