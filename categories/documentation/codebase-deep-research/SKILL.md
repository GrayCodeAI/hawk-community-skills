...
description: "Conduct multi-turn iterative deep research on topics within a codebase, tracing code paths and grounding every claim in evidence."
license: MIT
tags:
- research
- codebase
