---
name: docs-app-architecture
description: "Use when asked how the docs app works, where content lives, or whether an approach fits — especially MDX pipeline, markdown generation, components, and federated docs."
license: Apache-2.0
tags:
- documentation
- architecture
...
- `pm-the-docs` — audience, stage, and
...
- `test-the-docs` — execute docs snippets against a
...
- `review-the-docs` — reviewing open docs
