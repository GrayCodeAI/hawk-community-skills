---
name: openapi-spec-first-documentation
description: "Use when driving API development with an OpenAPI 3.x spec-first workflow — contract definition, code generation, and versioned specs."
license: MIT
tags:
- openapi
- swagger
