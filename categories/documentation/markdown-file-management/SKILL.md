...
description: "Create, read, and manage markdown documents through a suite CLI. Use when a user wants to work with .md files, notes, or markdown-based documentation."
license: MIT
tags:
- markdown
- documentation
...
- 用户要对 Markdown 文件做**rename / move / delete / 搜索 / 权限 / 评论**等云空间（云盘/云存储）操作，不要留在本 skill，切到 `lark-drive`
