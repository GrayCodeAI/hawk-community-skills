---
name: idiomatic-golang-development
description: "Use when building Go applications requiring concurrency, microservices, or performance — goroutines, channels, gRPC, generics, error handling, and table-driven testing."
license: MIT
tags:
- golang
- concurrency
