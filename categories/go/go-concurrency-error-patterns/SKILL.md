---
name: go-concurrency-error-patterns
description: "Use to implement Go concurrency, error handling, and HTTP server patterns: goroutines, channels, errgroup, and graceful shutdown."
license: MIT
tags:
- go
- concurrency
