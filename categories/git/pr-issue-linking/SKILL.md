...
description: "Append a GitHub issue reference and its associated project-ticket key to the current pull request description, resolving the ticket from the issue's linkback comment."
license: Apache-2.0
tags:
- git
- github
