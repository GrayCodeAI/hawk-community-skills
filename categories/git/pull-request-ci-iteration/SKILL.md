---
name: pull-request-ci-iteration
description: "Iterate on a pull request until CI passes and review feedback is addressed. Use for PR CI failures, review feedback, or green-check loops; do not wait for human approval or merge gates."
license: Apache-2.0
tags:
- git
- ci
