---
name: branch-creation-conventions
description: "Create a git branch with a conventional type/description name, choosing the base branch and avoiding collisions, based on the current diff or a given description."
license: Apache-2.0
tags:
- git
- branching
