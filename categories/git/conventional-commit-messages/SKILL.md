...
description: "Create conventional commit messages with issue references, imperative subjects, scoped types, and footers, committing one coherent change at a time on a feature branch."
license: Apache-2.0
tags:
- git
- commits
