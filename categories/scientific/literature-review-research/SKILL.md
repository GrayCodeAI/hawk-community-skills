...
description: "Use to find and synthesize research papers, whitepapers, and academic sources via semantic paper search, related-paper expansion, and in-body verification for literature reviews."
license: ISC
tags:
- research
- papers
