---
name: ai-research-papers-api
description: "Looks up, reads, and analyzes AI research paper pages in markdown and uses the papers API for structured metadata like authors and linked models, datasets, and repositories, including search feeds."
license: Apache-2.0
tags:
- research-papers
- arxiv
