---
name: orm-database-schema-management
description: "Use to design database schemas, write queries, manage migrations, and optimize the Prisma ORM client for production."
license: MIT
tags:
- database
- orm
