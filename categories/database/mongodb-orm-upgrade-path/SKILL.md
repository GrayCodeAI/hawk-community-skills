---
name: mongodb-orm-upgrade-path
description: "Use when a MongoDB project asks about upgrading the ORM — decide between staying on the current major version or migrating to the successor, with migration mechanics."
license: MIT
tags:
- mongodb
- database
