---
name: orm-cli-commands
description: "Use for ORM/database CLI workflows — init, generate, migrate, db, dev, studio, validate, format, debug, and MCP — for the ORM CLI, not the platform CLI."
license: MIT
tags:
- cli
- database
