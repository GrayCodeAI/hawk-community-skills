---
name: nosql-table-design
description: "Provisions NoSQL database instances and tables, designs performant row keys and column families, and queries data while diagnosing hotspots."
license: Apache-2.0
tags:
- database
- nosql
