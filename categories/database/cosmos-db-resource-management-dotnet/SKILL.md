---
name: cosmos-db-resource-management-dotnet
description: "Provision and manage NoSQL database accounts, databases, containers, and throughput in .NET via the resource-management plane."
license: MIT
tags:
- nosql
- database
