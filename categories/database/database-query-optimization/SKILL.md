...
description: "Optimizes database queries and performance across PostgreSQL and MySQL: execution plans, index design, configuration tuning, partitioning, and lock contention."
license: MIT
tags:
- database
- sql
