---
name: nosql-document-database-azure-cosmos-ts
description: "Perform CRUD, SQL queries, bulk, and patch operations on NoSQL documents with partition keys using the Cosmos client."
license: MIT
tags:
- nosql
- document-database
