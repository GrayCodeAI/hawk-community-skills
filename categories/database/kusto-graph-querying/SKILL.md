---
name: kusto-graph-querying
description: "Build transient and persistent graphs from tabular data with make-graph, pattern matching, shortest paths, and components."
license: MIT
tags:
- graph
- kql
