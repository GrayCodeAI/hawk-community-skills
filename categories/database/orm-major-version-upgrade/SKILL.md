---
name: orm-major-version-upgrade
description: "Use when upgrading the ORM from v6 to v7, encountering v7 errors, or migrating existing projects — covering generator, driver adapters, config, and ESM changes."
license: MIT
tags:
- migration
- database
