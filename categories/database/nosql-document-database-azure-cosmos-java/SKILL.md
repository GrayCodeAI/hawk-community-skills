---
name: nosql-document-database-azure-cosmos-java
description: "Build NoSQL document database apps with global distribution and reactive patterns using the Java Cosmos DB SDK."
license: MIT
tags:
- database
- nosql
