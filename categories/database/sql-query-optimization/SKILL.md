...
description: "Optimizes SQL queries and designs schemas: complex joins, window functions, CTEs, covering indexes, execution plan analysis, and cross-dialect query migration."
license: MIT
tags:
- sql
- database
