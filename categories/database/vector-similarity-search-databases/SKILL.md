---
name: vector-similarity-search-databases
description: "Use when building vector databases for similarity search over embeddings, covering ANN algorithms and dimensionality."
license: MIT
tags:
- vector-database
- embeddings
