---
name: orm-database-provider-setup
description: "Use when setting up a new project, changing database providers, configuring connection strings, troubleshooting connections, or generating and instantiating the client."
license: MIT
tags:
- database
- orm
