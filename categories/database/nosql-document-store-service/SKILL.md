---
name: nosql-document-store-service
description: "Build production-grade NoSQL database services with Python and FastAPI, including CRUD, partition keys, and TDD patterns."
license: MIT
tags:
- nosql
- database
