---
name: full-text-search-engine-cluster
description: "Use when designing search engine clusters for full-text search with indexing, queries, aggregations, and cluster management."
license: MIT
tags:
- search-engine
- full-text
