---
name: sql-server-provisioning-dotnet
description: "Provision and manage SQL server databases in .NET via the management plane, including servers, databases, elastic pools, and firewall rules."
license: MIT
tags:
- sql
- database
