...
description: "Analyze the downstream blast radius when a data warehouse table or view is broken, stale, or modified, using data lineage to identify all affected tables, dashboards, and processes."
license: Apache-2.0
tags:
- data-lineage
- impact-analysis
