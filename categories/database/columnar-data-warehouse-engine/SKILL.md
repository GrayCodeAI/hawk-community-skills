---
name: columnar-data-warehouse-engine
description: "Use when working with a cloud data warehouse: Dremel execution engine and Capacitor columnar storage format internals."
license: MIT
tags:
- database
- analytics
