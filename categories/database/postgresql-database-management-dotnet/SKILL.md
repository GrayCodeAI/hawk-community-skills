---
name: postgresql-database-management-dotnet
description: "Provision and manage PostgreSQL flexible-server databases in .NET, including servers, databases, firewall rules, backups, and high availability."
license: MIT
tags:
- postgresql
- database
