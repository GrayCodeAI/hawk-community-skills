---
name: sql-driver-adapter-implementation
description: "Use when implementing or modifying SQL driver adapters, adding database drivers, or touching transaction, savepoint, result mapping, or driver error behavior."
license: MIT
tags:
- database
- adapter
