...
description: "Use when planning database migrations: schema changes with Flyway/Liquibase/Alembic, online/offline strategies, zero-downtime deployments, and rollback."
license: MIT
tags:
- database
- migration
