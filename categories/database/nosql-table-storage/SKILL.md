---
name: nosql-table-storage
description: "Store and query NoSQL key-value entities in Python using the tables client for CRUD, filtering, and batch operations."
license: MIT
tags:
- nosql
- key-value
