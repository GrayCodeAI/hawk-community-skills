---
name: java-nosql-table-storage
description: "Store and query NoSQL key-value entities in Java with the tables client for CRUD, OData filters, and batch transactions."
license: MIT
tags:
- nosql
- key-value
