---
name: postgres-backend-platform
description: "Use when building a backend on a PostgreSQL backend-as-a-service — schema, row-level security, auth, realtime subscriptions, storage, edge functions."
license: MIT
tags:
- postgresql
- row-level-security
