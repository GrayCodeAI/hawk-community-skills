---
name: sql-query-orm-development
description: "Use to design schemas, write SQL-like queries, manage migrations, and optimize the Drizzle ORM for production and edge deployment."
license: MIT
tags:
- database
- orm
