...
description: "Generates or explains fully managed relational database resources (MySQL, PostgreSQL, SQL Server) including instance creation, connections, backups, high availability, and secure connectivity."
license: Apache-2.0
tags:
- database
- sql
