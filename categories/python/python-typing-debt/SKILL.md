---
name: python-typing-debt
description: "Remove assigned modules from mypy exclusion overrides in small batches, fix surfaced typing issues in scope, run validation, and report a structured summary."
license: Apache-2.0
tags:
- python
- mypy
