---
name: django-app-architecture
description: "Use when structuring Django applications — bounded-context apps, service layer, thin views, DRF serializers, and ORM."
license: MIT
tags:
- django
- python
