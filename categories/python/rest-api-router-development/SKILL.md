---
name: rest-api-router-development
description: "Create FastAPI routers with CRUD operations, authentication dependencies, and proper response models for REST endpoints."
license: MIT
tags:
- fastapi
- rest-api
