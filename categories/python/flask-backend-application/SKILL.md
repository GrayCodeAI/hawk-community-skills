---
name: flask-backend-application
description: "Use when building Flask backend applications — blueprints, app factory, extensions, SQLAlchemy, and WSGI deployment."
license: MIT
tags:
- flask
- python
