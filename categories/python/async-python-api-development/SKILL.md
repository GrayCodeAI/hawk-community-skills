---
name: async-python-api-development
description: "Use when building high-performance async Python REST APIs with FastAPI, Pydantic v2, JWT auth, async SQLAlchemy, or WebSockets; covers schemas, endpoints, and OpenAPI docs."
license: MIT
tags:
- fastapi
- pydantic
