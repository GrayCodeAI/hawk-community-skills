---
name: centralized-configuration-feature-flags
description: "Manage centralized configuration settings and feature flags with labels, read-only locks, and snapshots for dynamic settings."
license: MIT
tags:
- configuration
- feature-flags
