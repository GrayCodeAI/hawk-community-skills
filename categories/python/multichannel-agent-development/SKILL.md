---
name: multichannel-agent-development
description: "Build enterprise multichannel agents with the Agents SDK for Python, using aiohttp hosting, routing, streaming, and MSAL auth."
license: MIT
tags:
- agents
- bots
