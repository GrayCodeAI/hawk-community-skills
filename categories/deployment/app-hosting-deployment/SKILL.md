---
name: app-hosting-deployment
description: "Use when deploying or hosting an application — creating apps, deploying, managing logs and domains, or checking framework deploy readiness for the hosting platform."
license: MIT
tags:
- deployment
- hosting
