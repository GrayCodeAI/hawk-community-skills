---
name: video-search-app-deployment
description: "Deploys and manages a video search and summarization app through setup.sh and Docker Compose overlays across modes."
license: Apache-2.0
tags:
- deployment
- docker
...
- Exact mode-to-overlay/profile/service/URL mapping:
  `references/modes-and-overlays.md`.
