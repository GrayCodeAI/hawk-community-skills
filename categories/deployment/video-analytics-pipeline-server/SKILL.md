---
name: video-analytics-pipeline-server
description: "Deploys and operates a DL Streamer pipeline server microservice, managing video analytics pipelines via REST API."
license: Apache-2.0
tags:
- video-analytics
- deployment
...
- service-setup.md — Docker Compose, env vars, ports
- api-and-pipelines.md — Full API details, pipeline configs
- troubleshooting.md — GPU/NPU issues, RTSP failures
