---
name: mobile-web-hosting
description: "Deploy Expo web apps and API routes to managed edge hosting, author +api.ts route handlers, manage environment secrets and custom domains, and export the web bundle."
license: MIT
tags:
- hosting
- deployment
