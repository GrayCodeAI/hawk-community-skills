---
name: rag-chat-docker-deployment
description: "Deploys a question-and-answer chat application with Docker Compose across OpenVINO CPU, GPU, or Ollama backends."
license: Apache-2.0
tags:
- deployment
- docker
