---
name: end-to-end-app-onboarding
description: "Take an app from idea or existing code to a running cloud deployment with architecture planning, cost estimates, and IaC scaffolding."
license: MIT
tags:
- deployment
- onboarding
