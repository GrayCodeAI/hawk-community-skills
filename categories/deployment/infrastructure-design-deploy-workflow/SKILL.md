---
name: infrastructure-design-deploy-workflow
description: "Designs and deploys cloud infrastructure via modular Terraform with local validation, best-practice plan scans, template import to a design center registry, and deployment troubleshooting."
license: Apache-2.0
tags:
- terraform
- infrastructure
...
1.  [Pre-requisites: Setup &rough GCP Secret
        Manager.
