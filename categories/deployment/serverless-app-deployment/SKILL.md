...
description: "Deploys and manages serverless applications, covering HTTP services, scheduled or event-triggered jobs, and always-on worker pools for background processing."
license: Apache-2.0
tags:
- serverless
- deployment
