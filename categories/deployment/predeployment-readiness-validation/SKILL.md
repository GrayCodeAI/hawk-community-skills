---
name: predeployment-readiness-validation
description: "Run deep pre-deployment checks on configuration, infrastructure, RBAC, and managed identity before deploying."
license: MIT
tags:
- validation
- deployment
