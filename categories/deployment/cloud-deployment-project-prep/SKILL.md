---
name: cloud-deployment-project-prep
description: "Prepare a project for cloud deployment by creating a deployment plan, infrastructure templates, and Dockerfiles for the developer CLI workflow."
license: MIT
tags:
- deployment
- infrastructure
