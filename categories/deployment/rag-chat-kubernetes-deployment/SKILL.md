---
name: rag-chat-kubernetes-deployment
description: "Deploys a question-and-answer chat application to Kubernetes with Helm, translating Compose settings into chart values."
license: Apache-2.0
tags:
- kubernetes
- helm
