---
name: browser-automation-tracing
description: "Capture a full DevTools-protocol trace of browser automation with screenshots and DOM dumps, then bisect into per-page searchable buckets to debug failed runs."
license: Apache-2.0
tags:
- browser-automation
- debugging
