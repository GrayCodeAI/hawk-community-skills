---
name: windows-debug-output-capture
description: "Capture and analyze Windows usermode and kernel debug output from the command line with filtering and bounded execution."
license: MIT
tags:
- debugging
- windows
