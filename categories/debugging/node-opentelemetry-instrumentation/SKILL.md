---
name: node-opentelemetry-instrumentation
description: "Auto-instrument Node.js apps with OpenTelemetry to export distributed traces, metrics, and logs to application insights."
license: MIT
tags:
- telemetry
- tracing
