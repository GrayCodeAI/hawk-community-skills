---
name: mobile-performance-monitoring
description: "Track startup, navigation, and custom-event performance in production Expo apps with EAS Observe, adding instrumentation, querying metrics via CLI, and interpreting results."
license: MIT
tags:
- performance
- observability
