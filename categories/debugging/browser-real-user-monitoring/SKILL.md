---
name: browser-real-user-monitoring
description: "Instrument browser apps for real user monitoring of page views, clicks, AJAX, exceptions, and custom events with the web SDK."
license: MIT
tags:
...
- references/framework-extensions.md — React, React Native, Angular, Next.js, Vite recipes.
- references/configuration.md — Full `IConfiguration` reference and tuning guide.
