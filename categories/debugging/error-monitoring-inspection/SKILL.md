---
name: error-monitoring-inspection
description: "Inspect error tracking issues and events, summarize recent production errors, and pull basic health data using a read-only CLI."
license: MIT
tags:
- observability
- debugging
