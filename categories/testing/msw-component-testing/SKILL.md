---
name: msw-component-testing
description: "Use when writing or reviewing component tests that mock API requests at the network layer with MSW, or migrating tests away from module-level mocks."
license: Apache-2.0
tags:
- msw
- testing
