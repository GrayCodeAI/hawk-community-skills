---
name: browser-e2e-testing-automation
description: "Use when writing end-to-end browser tests with Playwright, using isolated contexts, auto-waiting, and tracing."
license: MIT
tags:
- e2e
- playwright
