...
description: "Use when writing end-to-end browser tests, setting up test infrastructure, creating page objects, configuring fixtures, or debugging flaky UI automation tests."
license: MIT
tags:
- e2e-testing
- browser-automation
