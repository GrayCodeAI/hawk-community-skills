...
description: "Evaluate Expo skills end-to-end for trigger accuracy, generated code quality, and runtime rendering, running the app on iOS and Android simulators and capturing screenshots."
license: MIT
tags:
- evaluation
- testing
