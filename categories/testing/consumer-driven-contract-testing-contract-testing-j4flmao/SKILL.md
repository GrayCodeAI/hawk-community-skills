---
name: consumer-driven-contract-testing-contract-testing-j4flmao
description: "Use when setting up consumer-driven contract testing with Pact to verify API compatibility between services."
license: MIT
tags:
- testing
- contract
