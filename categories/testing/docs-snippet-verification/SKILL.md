---
name: docs-snippet-verification
description: "Use when asked to test the docs, fact-check CLI/SQL/code samples, or run runnable documentation snippets inside a disposable Docker sandbox to produce a verification report."
license: Apache-2.0
tags:
- documentation
- testing
...
For lint, markdown rebuilds, example-app triage, and PR review, use `review-the-docs`. For Frame/Shape and cross-repo product lookup, use `pm-the-docs`.
...
- `write-the-docs` — Draft; hands off here before PR
- `review-the-docs` — lint/build/classify; consumes verification report
- `pm-the-docs` — Frame/Shape; universe for cross-repo product lookup
