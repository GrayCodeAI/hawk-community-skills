---
name: live-site-qa-testing
description: "Use to QA test a live website with browser and scrape evidence: exploratory QA, form testing, navigation/link checks, responsive and performance checks, and bug reports."
license: ISC
tags:
- testing
- qa
