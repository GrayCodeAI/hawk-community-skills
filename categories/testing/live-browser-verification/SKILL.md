...
description: "Use when building or debugging anything that runs in a browser to inspect the DOM, capture console errors, analyze network requests, profile performance, and verify visual output live."
license: MIT
tags:
- browser-testing
- devtools
