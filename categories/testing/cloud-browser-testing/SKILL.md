---
name: cloud-browser-testing
description: "Run Playwright browser tests at scale on cloud-hosted browsers and publish results to the portal with CI/CD integration."
license: MIT
tags:
- testing
- browser-testing
