---
name: logging-configuration-basics
description: "Configures single-project centralized logging including regional log buckets, sinks, views, access restriction, logs-based metrics, exclusions, and sampling."
license: Apache-2.0
tags:
- logging
- observability
