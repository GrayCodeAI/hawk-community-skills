...
description: "Plan, generate, validate, and safely execute cloud CLI commands with leaf-level syntax validation, data-reduction flags, non-interactive execution, and guardrails against destructive operations."
license: Apache-2.0
tags:
- cli
- cloud
