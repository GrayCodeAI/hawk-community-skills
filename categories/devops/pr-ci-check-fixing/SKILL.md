---
name: pr-ci-check-fixing
description: "Debug and fix failing GitHub PR checks by inspecting checks and logs with the GitHub CLI, summarizing failures, and implementing fixes after approval."
license: MIT
tags:
- ci
- github
