...
description: "Generates valid PromQL queries from metric descriptors and resource parameters, applying aggregation rules and validating with a linter."
license: Apache-2.0
tags:
- promql
- monitoring
...
2.  **Linter Verification**:
    ...
    *   If validation fails, read
        PromQL Error Recovery Guide to
