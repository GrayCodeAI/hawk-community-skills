---
name: log-query-generation
description: "Generate correct Logging Query Language (LQL) queries from natural language to filter cloud log data by service, resource type, or field, for debugging and audit analysis."
license: Apache-2.0
tags:
- logging
- queries
