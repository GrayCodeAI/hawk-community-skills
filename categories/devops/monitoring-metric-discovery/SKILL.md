---
name: monitoring-metric-discovery
description: "Finds and identifies relevant cloud monitoring metric descriptors for a service or resource by querying the API and filtering by keywords."
license: Apache-2.0
tags:
- monitoring
- metrics
