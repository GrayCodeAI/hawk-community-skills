...
description: "Enable, optimize, and troubleshoot Kubernetes cluster autoscaling, node auto-provisioning, and node-pool auto-creation, including scale blockers, zonal stockouts, and consolidation tuning."
license: Apache-2.0
tags:
- kubernetes
- autoscaling
...
- ca-consolidation-tuning.md: `autoscalingPolicy` fields, disruption constraints, tuning by workload type.
