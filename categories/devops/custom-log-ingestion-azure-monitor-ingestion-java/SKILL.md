---
name: custom-log-ingestion-azure-monitor-ingestion-java
description: "Send custom logs to a monitoring workspace via data collection rules and endpoints using the Java Monitor Ingestion SDK."
license: MIT
tags:
- logging
- monitoring
