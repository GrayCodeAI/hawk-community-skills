---
name: mobile-ci-cd-workflows
description: "Write, edit, and validate EAS workflow YAML files for Expo CI/CD pipelines, covering triggers, jobs, expressions, and pre-packaged job types with CLI validation."
license: MIT
tags:
- ci-cd
- workflows
