---
name: cross-project-log-routing
description: "Configures and troubleshoots cross-project centralized logging and read-time aggregation, routing logs from multiple projects, folders, or organizations to a central log bucket."
license: Apache-2.0
tags:
- logging
- observability
