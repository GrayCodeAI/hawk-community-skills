---
name: gitops-pull-deployment
description: "Use when implementing GitOps with ArgoCD: pull-based deployment where an in-cluster agent monitors Git and reconciles desired state."
license: MIT
tags:
- gitops
- kubernetes
