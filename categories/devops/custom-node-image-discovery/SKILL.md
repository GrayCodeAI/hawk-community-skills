---
name: custom-node-image-discovery
description: "Discovers golden base images for creating custom Kubernetes node images based on version, OS, architecture, and accelerator specifications."
license: Apache-2.0
tags:
- kubernetes
- images
