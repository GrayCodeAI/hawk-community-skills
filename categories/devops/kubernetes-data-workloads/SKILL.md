---
name: kubernetes-data-workloads
description: "Use when running data workloads on Kubernetes: Spark/Airflow/Kafka operators, GPU scheduling, node pools, and storage optimization."
license: MIT
tags:
- kubernetes
- spark
