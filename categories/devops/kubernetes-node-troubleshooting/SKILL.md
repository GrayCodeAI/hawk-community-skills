---
name: kubernetes-node-troubleshooting
description: "Diagnoses Kubernetes/GKE nodes stuck NotReady by inspecting node conditions, kubelet and containerd logs, and metrics, then proposes safe read-only remediations for a human to apply."
license: Apache-2.0
tags:
- kubernetes
- troubleshooting
