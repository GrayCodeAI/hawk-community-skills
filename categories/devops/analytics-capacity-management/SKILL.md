---
name: analytics-capacity-management
description: "Create, scale, suspend, and manage analytics capacity resources programmatically with the Fabric management Python SDK."
license: MIT
tags:
- infrastructure
- capacity
