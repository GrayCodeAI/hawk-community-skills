...
description: "Generate an interactive bash wizard that walks a human through manual steps like provisioning infra, setting credentials, or running a migration."
license: MIT
tags:
- wizard
- setup
