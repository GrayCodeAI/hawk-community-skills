---
name: centralized-app-configuration
description: "Manage centralized configuration settings and feature flags with dynamic refresh, snapshots, and key vault references."
license: MIT
tags:
- configuration
- feature-flags
