...
description: "Manages Kubernetes storage including persistent volume claims, persistent volumes, shared file storage, and object-storage FUSE mounts, plus storage classes and volume expansion."
license: Apache-2.0
tags:
- kubernetes
- storage
