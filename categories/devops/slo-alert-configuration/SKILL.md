---
name: slo-alert-configuration
description: "Guides configuring PromQL-based Service Level Objective alerting policies for cloud resources, generating Terraform monitoring config with SRE best practices for burn-rate alerts."
license: Apache-2.0
tags:
- slo
- alerting
