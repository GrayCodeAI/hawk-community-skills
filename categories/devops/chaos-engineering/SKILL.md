...
description: "Designs chaos experiments and failure injection for distributed systems: hypothesis, blast radius control, game days, rollback, and continuous resilience testing."
license: MIT
tags:
- chaos-engineering
- resilience
