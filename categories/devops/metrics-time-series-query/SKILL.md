---
name: metrics-time-series-query
description: "Builds valid Cloud Monitoring ListTimeSeries REST requests and aggregation specs from metric descriptors: filter expressions, aligner/reducer selections, alignment periods, and request validation."
license: Apache-2.0
tags:
- monitoring
- metrics
