...
class KubernetesRBACAuditor:
    ...
    def _audit_cluster_admin_bindings(self):
        cluster_admin_bindings = [
            b for b in self.bindings if b.role_ref == "cluster-admin" and b.is_cluster_binding
        ]
        ...
        [
            {
                ...
                "subjects": [
                    {"kind": "ServiceAccount", "name": "ci-deployer", "namespace": "ci-cd"}
                ],
            },
            {
                "name": "dev-binding",
            ...
            },
            {
                ...
                "role_ref_kind": "Role",
                "subjects": [
                    {"kind": "ServiceAccount", "name": "default", "namespace": "app-team"}
                ],
            },
        ]
    )
