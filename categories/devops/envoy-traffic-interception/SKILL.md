---
name: envoy-traffic-interception
description: "Use when working with proxy service mesh internals: traffic interception, xDS configuration, and socket-level routing optimizations."
license: MIT
tags:
- service-mesh
- istio
