---
name: opentelemetry-telemetry-export
description: "Export OpenTelemetry traces, metrics, and logs to an application insights workspace using the Python exporter clients."
license: MIT
tags:
- opentelemetry
- telemetry
