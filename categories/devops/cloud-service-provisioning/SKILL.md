---
name: cloud-service-provisioning
description: "Use to provision third-party services such as databases, auth, hosting, caching, analytics, and AI, and to retrieve API keys or credentials via the CLI projects plugin."
license: MIT
tags:
- provisioning
- cloud
