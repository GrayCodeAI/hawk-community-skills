...
description: "Use when setting up or operating Jenkins CI/CD: declarative/scripted Jenkinsfiles, shared libraries, multibranch builds, security hardening, and high availability."
license: MIT
tags:
- devops
- ci-cd
