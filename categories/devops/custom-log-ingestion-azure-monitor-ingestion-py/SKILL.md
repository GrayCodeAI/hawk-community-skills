---
name: custom-log-ingestion-azure-monitor-ingestion-py
description: "Send custom logs to a Log Analytics workspace via the Logs Ingestion API using data collection rules and endpoints."
license: MIT
tags:
- logging
- monitoring
