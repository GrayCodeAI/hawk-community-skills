...
description: "Use when building observability for AI agent systems: tracing reasoning paths, OpenTelemetry instrumentation, audit logging, and cost analysis."
license: MIT
tags:
- observability
- tracing
