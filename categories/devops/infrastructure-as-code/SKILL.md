...
description: "Implements infrastructure as code with Terraform: reusable modules, remote state, provider configuration, multi-environment workflows, and infrastructure testing across cloud providers."
license: MIT
tags:
- terraform
- iac
