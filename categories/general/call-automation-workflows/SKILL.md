---
name: call-automation-workflows
description: "Build server-side call automation (IVR, call routing, recording, DTMF, text-to-speech) with the Java Call Automation SDK."
license: MIT
tags:
- telephony
- ivr
