...
class EvidenceCollector:
    ...
    def collect_system_info(self):
        ...
        info = {
            ...
            "network_interfaces": {
                name: [{"address": addr.address, "family": str(addr.family)} for addr in addrs]
...
def main():
    ...
    parser.add_argument(
        "--skip-memory", action="store_true", help="Skip memory dump (use dedicated tool)"
    )
    parser.add_argument(
        "--collect-all", action="store_true", help="Collect all available evidence types"
    )
