---
name: composable-cli-builder
description: "Build a durable, composable command-line tool from API docs, OpenAPI specs, SDKs, or existing scripts that exposes composable read/write commands with stable JSON output."
license: MIT
tags:
- cli
- command-line
