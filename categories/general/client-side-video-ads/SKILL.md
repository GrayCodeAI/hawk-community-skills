---
name: client-side-video-ads
description: "Integrate an interactive media ads SDK for client-side ad insertion, requesting video and audio ads from VAST or VMAP ad servers. Use when requesting in-stream video ads."
license: Apache-2.0
tags:
- video
- ads
...
*   **Web/HTML5/ReactJs/NodeJs/Angular:** Read all these guides
    ima-sdk-web-guide.md,
    ima-sdk-web-iframe-mode.md,
...
*   **iOS/tvOS/ReactNative:** Read all these guides
    ima-sdk-ios-guide.md,
    ima-sdk-tvos-guide.md
