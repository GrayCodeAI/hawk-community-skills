---
name: reactive-java-backend-development
description: "Use when building Quarkus backend apps with reactive messaging, Panache ORM, Dev UI, live reload, and GraalVM native compilation."
license: MIT
tags:
- java
- backend
