...
description: "Set up, improve, or audit analytics tracking, including event naming conventions, tag manager implementation, UTM parameters, and data quality validation."
license: MIT
tags:
- analytics
- tracking
