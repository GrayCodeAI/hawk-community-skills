---
name: investor-pitch-deck-create-pitch-deck
description: "Use to build an investor pitch deck slide-by-slide with a storytelling arc, key metrics, and stage-specific content for fundraising."
license: MIT
tags:
- pitch
- fundraising
