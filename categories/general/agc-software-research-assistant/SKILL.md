---
name: agc-software-research-assistant
description: "Use this agent when you need technical research on a specific library, framework, package, or API for software implementation. This agent focuses on gathering implementation details, best practices..."
license: MIT
tags: [general]
model: inherit
memory: project
