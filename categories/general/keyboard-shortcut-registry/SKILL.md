...
description: "Use when adding repeated user actions, toolbar actions, list/table operations, or search inputs that need keyboard shortcut coverage, or when registering or changing shortcuts."
license: Apache-2.0
tags:
- shortcuts
- keyboard
