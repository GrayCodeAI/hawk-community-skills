---
name: web-data-sdk-setup
description: "Set up API credentials and SDK for a web-data service in a project; use when wiring the API key, installing the SDK, or choosing the first integration path."
license: ISC
tags:
- sdk-setup
- credentials
