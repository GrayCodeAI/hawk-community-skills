---
name: notion-api-cli
description: "Use when calling the Notion API, deploying workers, uploading files, creating pages, querying databases, or any task involving the ntn command-line tool."
license: MIT
tags:
- notion
- api
