...
description: "Use when adding analytics tracking calls, defining event constants, implementing tracking for a new feature, or reviewing PRs for telemetry naming and property compliance."
license: Apache-2.0
tags:
- telemetry
- analytics
