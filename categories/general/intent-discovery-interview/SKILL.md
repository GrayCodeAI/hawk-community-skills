---
name: intent-discovery-interview
description: "Use when an ask is underspecified to extract what the user actually wants via one-question-at-a-time interviews with hypotheses until intent reaches high confidence before planning."
license: MIT
tags:
- requirements
- discovery
