...
description: "Use when building WordPress themes and plugins, Gutenberg blocks, WooCommerce stores, or REST API endpoints; covers hooks, performance, and security hardening best practices."
license: MIT
tags:
- wordpress
- php
