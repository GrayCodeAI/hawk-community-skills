---
name: external-app-tool-integration
description: "Access and automate 1000+ external apps via CLI or SDK, building agents and applications with per-user tool connections."
license: MIT
tags:
- automation
- tools
