...
description: "Design polished microinteractions—triggers, rules, feedback, loops, and modes—for toggles, loading states, and state transitions that feel responsive."
license: MIT
tags:
- ui
- design
