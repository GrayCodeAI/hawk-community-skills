...
6. Ask the chatbot to run the workflow from [_rule-workbench/PROCESS.md](PROCESS.md) for that book.
7. Ask the chatbot to execute the release instructions from [_rule-workbench/RELEASE.md](RELEASE.md).