---
name: frontend-bundler-optimization
description: "Use when configuring and optimizing frontend build tooling — bundler selection, code splitting, tree shaking, and build performance."
license: MIT
tags:
- bundler
- build
