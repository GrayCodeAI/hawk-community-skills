...
description: "Build a throwaway prototype to answer a design question about logic, state models, or UI look, then capture the validated decision in real code."
license: MIT
tags:
- prototyping
- design
