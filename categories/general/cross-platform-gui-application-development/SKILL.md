---
name: cross-platform-gui-application-development
description: "Use to build cross-platform desktop and embedded apps with Qt using QtWidgets, QtQuick/QML, signals and slots, and model-view architecture."
license: MIT
tags:
- desktop
- cross-platform
