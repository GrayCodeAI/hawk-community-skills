...
class CertLifecycleAgent:
    ...
    def generate_csr(self, common_name, org="", country="US", san_names=None, key_type="ecdsa"):
    ...
    def fetch_remote_cert(self, hostname, port=443):
        ...
        try:
            ...
            not_before = datetime.strptime(pem_info["notBefore"], "%b %d %H:%M:%S %Y %Z")
...
def main():
    hosts = (
        sys.argv[1:] if len(sys.argv) > 1 else ["google.com", "github.com", "expired.badssl.com"]
    )
