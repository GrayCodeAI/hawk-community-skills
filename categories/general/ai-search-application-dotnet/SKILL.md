---
name: ai-search-application-dotnet
description: "Build .NET search applications with full-text, vector, semantic, and hybrid search over indexes with filtering, facets, and suggestions."
license: MIT
tags:
- search
- ai
