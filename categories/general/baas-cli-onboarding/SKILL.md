---
name: baas-cli-onboarding
description: "Handles backend-as-a-service CLI setup, authentication, project creation and selection, and downloading app config files for mobile and web apps."
license: Apache-2.0
tags:
- cli
- setup
