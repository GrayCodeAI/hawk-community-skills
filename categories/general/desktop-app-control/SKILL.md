...
description: "Drive OS/window-level inspection and input in visible local app windows and external browsers, including clicks, typing, and accessibility actions."
license: MIT
tags:
- computer-use
- ui-automation
