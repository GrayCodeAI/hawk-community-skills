...
description: "Integrate single-page extraction into app code when you already have a URL and need markdown, HTML, links, screenshots, or structured page output."
license: ISC
tags:
- web-scraping
- extraction
