---
name: swift-server-http-development
description: "Use when building Vapor Swift backends: async routes, Fluent ORM, middleware pipeline, and WebSocket support."
license: MIT
tags:
- swift
- backend
