---
name: agent-config-migration
description: "Migrate instruction files, skills, agents, and MCP config from one agent toolchain into another's project and global files."
license: MIT
tags:
- migration
- agent-config
