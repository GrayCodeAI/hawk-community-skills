---
name: rails-web-application-development
description: "Use when building Rails 7+ web apps with Hotwire, real-time features, or background jobs — Active Record optimization, Turbo Frames/Streams, Action Cable, Sidekiq, RSpec."
license: MIT
tags:
- rails
- ruby
