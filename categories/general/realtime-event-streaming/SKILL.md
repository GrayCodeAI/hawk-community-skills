...
description: "Subscribe to and process realtime events from a collaboration suite: handle webhooks, stream updates, and react to changes. Use when a user wants event-driven integration."
license: MIT
tags:
- events
- webhooks
