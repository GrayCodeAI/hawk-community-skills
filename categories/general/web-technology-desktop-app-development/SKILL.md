---
name: web-technology-desktop-app-development
description: "Use to build cross-platform desktop apps with Electron covering main/renderer processes, IPC, security, packaging, and auto-update."
license: MIT
tags:
- desktop
- javascript
