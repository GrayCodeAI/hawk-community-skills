---
name: cpp-performance-programming
description: "Use when working on C++ performance programming, RAII, smart pointers, move semantics, templates, and low-level memory management."
license: MIT
tags:
- cpp
- performance
