---
name: client-server-state-fetching
description: "Use when managing server state on the client with TanStack Query or SWR — caching, optimistic updates, pagination, and invalidation."
license: MIT
tags:
- data-fetching
- caching
