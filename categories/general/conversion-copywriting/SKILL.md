...
description: "Write, rewrite, or improve persuasive marketing copy for homepages, landing pages, pricing pages, and more — headlines, CTAs, value propositions, and benefit-driven copy that converts."
license: MIT
tags:
- copywriting
- marketing
...
**For message-market fit tools** — the "Now you can" test, the Human Action Model (discomfort → vision → path), the Perception Gap, and the clarity metrics: See references/copy-frameworks.md
...
**Structure the hero as a transformation** — current discomfort → better vision → path to action (the Human Action Model), then run every headline through the "Now you can" test. See references/copy-frameworks.md
