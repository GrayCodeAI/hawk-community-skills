---
name: large-effort-wayfinding
description: "Plan work too big for one agent session as a shared map of decision tickets on the issue tracker, resolving them one at a time until the way is clear."
license: MIT
tags:
- planning
- tickets
