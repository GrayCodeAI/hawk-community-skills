---
name: event-streaming-ingestion-azure-eventhub-ts
description: "Ingest and process high-throughput event streams with partitioned producers and consumers, including checkpointing, in Node.js."
license: MIT
tags:
- event-streaming
- real-time
