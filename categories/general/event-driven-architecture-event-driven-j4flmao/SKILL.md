---
name: event-driven-architecture-event-driven-j4flmao
description: "Use when designing event-driven systems — event buses, domain events, pub/sub, and asynchronous processing patterns."
license: MIT
tags:
- event-driven
- events
