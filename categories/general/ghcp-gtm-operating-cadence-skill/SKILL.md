---
name: ghcp-gtm-operating-cadence-skill
description: Design meeting rhythms, metric reporting, quarterly planning, and decision-making
  velocity for scaling companies. Use when decisions are slow, planning is broken,
  the company is growing but alignme...
license: MIT
tags:
- general
metadata: None
