---
name: lock-free-ring-buffers
description: "Design lock-free architectures with ring buffers and sequence barriers for high-throughput, low-jitter inter-thread communication."
license: MIT
tags:
- concurrency
- ring-buffer
