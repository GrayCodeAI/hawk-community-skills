---
name: java-enterprise-framework-patterns
description: "Use when implementing Spring Boot patterns: DI, AOP, repositories, security, transactions, and slice testing."
license: MIT
tags:
- java
- backend
