---
name: javascript-web-animation
description: "Animate DOM, SVG, and JavaScript objects with tweens, timelines, staggers, springs, scroll triggers, and draggable elements for interactive web motion."
license: MIT
tags:
- animation
- javascript
