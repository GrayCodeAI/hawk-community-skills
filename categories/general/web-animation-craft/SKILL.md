---
name: web-animation-craft
description: "Build a web animation from scratch, deciding whether it should animate, the tool, properties, easing, duration, interruption, and exit, then writing the implementation."
license: MIT
tags:
- animation
- motion
