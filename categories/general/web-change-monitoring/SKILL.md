---
name: web-change-monitoring
description: "Use to watch a page, site, or the whole web for content changes and get alerted by webhook or email, instead of repeated one-off scrapes."
license: ISC
tags:
- monitoring
- alerts
