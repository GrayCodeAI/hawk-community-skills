---
name: integration-example-library
description: "Find and adapt canonical, version-matched integration examples for third-party libraries and services in an Expo app, or scaffold a new project from one."
license: MIT
tags:
- examples
- integrations
