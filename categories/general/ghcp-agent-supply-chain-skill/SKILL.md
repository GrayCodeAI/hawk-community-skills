---
name: ghcp-agent-supply-chain-skill
description: 'Skill: ghcp-agent-supply-chain-skill'
license: MIT
tags:
- general
Verify supply chain integrity for AI agent plugins, tools, and dependencies. Use this skill when: None
---
