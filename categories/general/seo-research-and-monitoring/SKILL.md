---
name: seo-research-and-monitoring
description: "Research search demand, build writer briefs and question maps, and monitor search performance with sourced metrics."
license: MIT
tags:
- seo
- research
...
Full per-tool procedure, match types, and the no-data path: references/research-protocol.md.
...
Template: references/brief-template.md. Copy it rather than improvising the shape.
...
What each cadence checks and what earns a message: references/monitoring.md.
...
- references/research-protocol.md: per-job pull procedure, match types, scope and date windows, the no-data path, the evidence table format; read during Mode A steps 1 and 4
- references/brief-template.md: the brief itself; copy during Mode A step 3
- references/monitoring.md: what each cadence checks and what earns a message; read in Mode B
