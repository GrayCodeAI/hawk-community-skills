---
name: hub-api-tool-builder
description: "Build reusable CLI scripts and utilities that fetch, enrich, or process data from the Hub API, chaining and piping API calls with authentication."
license: Apache-2.0
tags:
- api
- cli
