---
name: api-product-lifecycle
description: "Use when managing APIs as products — strategy, developer experience, monetization, developer portals, analytics, and lifecycle."
license: MIT
tags:
- api
- product-management
...
## References
- Product Management Fundamentals — API product management fundamentals: lifecycle, maturity model, strategy canvas, governance
- Product Management Advanced — Advanced API product strategy: consumer insights, SLA management, partnership programs
- API Lifecycle Management — Full lifecycle: design to sunset, versioning, migration
- API Strategy — API business models, strategy canvas, governance
- Developer Experience — DX principles, SDKs, documentation, error messages
- Developer Portal — Developer portal design, self-service onboarding, analytics
- Monetization — Pricing models, usage tracking, rate limiting tiers
- Product Metrics — Adoption, DX, reliability, and business metrics with dashboards
- API Consumer Insights — Consumer lifecycle, health scoring, churn prediction
- API Governance — Governance framework, API council, design standards
- API Stakeholder Management — Stakeholder mapping, communication, escalation
- API Launch Playbook — Launch planning, execution, metrics, retrospective
