---
name: pixi-filter-effects
description: "Apply visual effects to PixiJS v8 containers via the filter pipeline: built-in filters (blur, color matrix, displacement, noise) and custom GLSL/WGSL shaders."
license: MIT
tags:
- pixijs
- filters
