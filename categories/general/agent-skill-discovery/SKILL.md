...
description: "Use when starting a session or classifying a task into the right development phase — discovers and invokes the appropriate skill for the current work."
license: MIT
tags:
- meta
- workflow
