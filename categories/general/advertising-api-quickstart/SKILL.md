---
name: advertising-api-quickstart
description: "Guide through advertising API quickstart: credential setup, client libraries or REST, and running a first request. Troubleshoots common setup errors like permission and token approval issues."
license: Apache-2.0
tags:
- api
- advertising
