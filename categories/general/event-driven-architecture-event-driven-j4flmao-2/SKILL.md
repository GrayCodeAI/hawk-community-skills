---
name: event-driven-architecture-event-driven-j4flmao-2
description: "Use when decoupling services with event-driven architecture, pub/sub, and transactional outbox patterns."
license: MIT
tags:
- event-driven
- messaging
