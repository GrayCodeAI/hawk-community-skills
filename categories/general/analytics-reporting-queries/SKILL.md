...
description: "Runs customized analytics reports via the Data API, querying metrics and dimensions, checking compatibility, and building dashboards and reporting workflows across supported client libraries."
license: Apache-2.0
tags:
- analytics
- reporting
