...
description: "Use to clarify brand messaging by positioning the customer as hero; apply the SB7 framework to write one-liners, homepage copy, and consistent marketing collateral."
license: MIT
tags:
- copywriting
- brand
