---
name: professional-network-posting
description: "Write high-engagement professional network posts with hook formulas, formatting rules, content pillars, and algorithm signals."
license: MIT
tags:
- social-media
- content
