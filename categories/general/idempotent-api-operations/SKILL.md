...
description: "Use when ensuring safe retries for mutating endpoints — idempotency keys, exactly-once semantics, deduplication, and concurrent request handling."
license: MIT
tags:
- idempotency
- retry
