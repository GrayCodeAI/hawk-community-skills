...
description: "Use for marketing ideas, inspiration, or strategy for a SaaS product, matching proven tactics to the user's stage, budget, and timeline."
license: MIT
tags:
- marketing
- growth
...
- **Guerrilla marketing (#121)**: references/guerrilla-marketing.md — the direct-mail 3-rule framework (relevance / relationship-building / precision targeting), ROI discipline, "think in stories, not campaigns," "test small before going big," and a named case library (WePay, Xero, Red Bull, Antimetal, Arrows, ProfitWell, Buzzsprout, Wistia).
