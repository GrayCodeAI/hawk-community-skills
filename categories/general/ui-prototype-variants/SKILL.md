---
name: ui-prototype-variants
description: "Build several genuinely different versions of a described UI piece behind a visual picker so the user can flip through them live and promote a winner."
license: MIT
tags:
- prototyping
- ui
