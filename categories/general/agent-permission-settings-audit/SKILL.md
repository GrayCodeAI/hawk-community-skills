---
name: agent-permission-settings-audit
description: "Generate recommended agent settings.json permissions for read-only commands by analyzing a repository's tech stack and structure. Use when setting up a new project or auditing existing settings."
license: Apache-2.0
tags:
- configuration
- permissions
