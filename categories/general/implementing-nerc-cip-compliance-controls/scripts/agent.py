...
NERC_CIP_CONTROLS = {
    ...
    "CIP-006": {
        ...
        "checks": ["physical_security_plan", "visitor_control_program", "psp_access_monitoring"],
    },
    "CIP-007": {
    ...
    "CIP-008": {
        ...
        "checks": ["incident_response_plan", "incident_response_testing", "reporting_procedures"],
    },
    "CIP-009": {
        "name": "Recovery Plans",
        "checks": ["recovery_plans_exist", "backup_procedures", "recovery_testing_annual"],
    },
    "CIP-010": {
    ...
    "CIP-013": {
        ...
        "checks": ["supply_chain_plan", "vendor_risk_assessment", "vendor_notification_process"],
    },
}
