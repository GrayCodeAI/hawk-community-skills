---
name: std-nextjs-server-components
description: "Build async React Server Components and place 'use client' boundaries at leaf nodes for interactivity in Next.js App Router. Use when deciding RSC vs Client Component, composing server data into cl..."
license: MIT
tags: [general]
metadata: None
triggers: None
...
- _Fix_: Pass as `children` prop. See Composition Example.
