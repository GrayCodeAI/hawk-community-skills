---
name: native-macos-app-development
description: "Use to build native macOS apps with AppKit, Cocoa, NSView/NSViewController, document architecture, menus, and drag-and-drop."
license: MIT
tags:
- macos
- desktop
