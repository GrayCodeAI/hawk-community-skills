---
name: ghcp-pr-dashboard-skill
description: "Open a GitHub PR dashboard in the browser. Use when the user asks to see their pull requests, open the PR dashboard, show PRs for a date range, or check PR status. Trigger phrases include \"show my ..."
license: MIT
tags: [general]
---
