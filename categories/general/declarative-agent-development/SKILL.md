---
name: declarative-agent-development
description: "Create, build, deploy, and localize declarative agents for Copilot and Teams, including scaffolding, editing manifests, and adding plugins."
license: MIT
tags:
- ai-agents
- app-development
