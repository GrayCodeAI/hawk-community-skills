---
name: windows-universal-app-development
description: "Use to build Universal Windows Platform apps with XAML, WinRT APIs, adaptive layout, background tasks, and Store deployment."
license: MIT
tags:
- windows
- desktop
