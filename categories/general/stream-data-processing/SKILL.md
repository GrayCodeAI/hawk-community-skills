...
description: "Use when building high-throughput message processing with Kafka or Flink — partitions, offsets, stateful processing, and exactly-once semantics."
license: MIT
tags:
- streaming
- kafka
