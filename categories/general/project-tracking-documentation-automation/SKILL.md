---
name: project-tracking-documentation-automation
description: "Use when managing project tracking and documentation via MCP — query issues with JQL, edit wiki pages with CQL, manage sprints, and configure authentication."
license: MIT
tags:
- project-management
- documentation
