---
name: scene-graph-container
description: "Group, position, and transform display objects in a 2D scene graph with containers, children, z-index sorting, and bounds."
license: MIT
tags:
- scene-graph
- container
