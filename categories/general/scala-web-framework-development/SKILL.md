---
name: scala-web-framework-development
description: "Use when building Scala Play Framework apps: MVC, Slick database access, Play JSON, async actions, and testing."
license: MIT
tags:
- scala
- backend
