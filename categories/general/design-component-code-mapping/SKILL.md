---
name: design-component-code-mapping
description: "Map design components to their code implementations using Code Connect, scanning the codebase for matching components and creating mappings."
license: MIT
tags:
- design
- components
