---
name: multi-product-solution-design
description: "Runs an interactive workflow to discover requirements and design holistic multi-product cloud system architectures, blueprints, architecture diagrams, and deployment guidance for complex workloads."
license: Apache-2.0
tags:
- architecture
- solution-design
