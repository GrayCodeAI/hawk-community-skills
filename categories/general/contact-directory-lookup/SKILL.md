...
description: "Look up people and organizational structure through a suite CLI: search contacts, view departments, and resolve member details. Use when a user needs directory or user information."
license: MIT
tags:
- contacts
- directory
