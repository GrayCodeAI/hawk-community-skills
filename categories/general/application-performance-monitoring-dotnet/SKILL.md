---
name: application-performance-monitoring-dotnet
description: "Manage application performance monitoring resources in .NET, including insights components, web tests, workbooks, and API keys."
license: MIT
tags:
- observability
- monitoring
