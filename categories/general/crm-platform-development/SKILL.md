---
name: crm-platform-development
description: "Use when developing on the Salesforce platform — Apex, Lightning Web Components, SOQL, triggers, batch jobs, integrations, and DX/CI-CD."
license: MIT
tags:
- crm
- apex
