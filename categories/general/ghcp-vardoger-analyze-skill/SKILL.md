---
name: ghcp-vardoger-analyze-skill
description: "Use when the user asks to personalize the GitHub Copilot CLI assistant, adapt Copilot to their style, use vardoger, or analyze their Copilot CLI conversation history. Reads the local session direct..."
license: Apache-2.0
tags: [general]
---
