---
name: web-search-with-content
description: "Use to search the web when no URL is known, returning results as JSON with optional full page content for finding sources, articles, or news."
license: ISC
tags:
- search
- web
...
- firecrawl-research-index — published papers, not `search --categories research`
