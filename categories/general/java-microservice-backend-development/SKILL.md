---
name: java-microservice-backend-development
description: "Use when building Micronaut apps with compile-time DI, reactive HTTP, AOT optimization, GraalVM native, and declarative HTTP clients."
license: MIT
tags:
- java
- backend
