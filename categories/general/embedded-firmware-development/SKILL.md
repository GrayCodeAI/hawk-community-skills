...
description: "Develops firmware for microcontrollers and RTOS: peripheral drivers, interrupt handlers, DMA, power optimization, and real-time systems for STM32, ESP32, and bare-metal targets."
license: MIT
tags:
- embedded
- firmware
