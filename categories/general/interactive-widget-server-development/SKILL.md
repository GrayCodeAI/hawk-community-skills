---
name: interactive-widget-server-development
description: "Build MCP servers that render rich interactive React and Fluent UI widgets inside Copilot Chat, exposing tools via structuredContent."
license: MIT
tags:
- mcp
- widgets
