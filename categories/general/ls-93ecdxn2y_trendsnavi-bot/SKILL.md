---
name: ls-93ecdxn2y_trendsnavi-bot
description: "Skill: ls-93ecdxn2y_trendsnavi-bot"
license: MIT
tags: [general]
---
...
GPT Description: 検索データやニュース・SNSデータなどを分析し、流行やトレンドを調査・横断分析するアナリティクスBOTです。実際のリアルタイムデータを分析します。まずは調べたいキーワードを入力してください。 - By gaaaon.jp
