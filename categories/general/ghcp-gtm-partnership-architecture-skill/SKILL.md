---
name: ghcp-gtm-partnership-architecture-skill
description: Build and scale partner ecosystems that drive revenue and platform adoption.
  Use when building partner programs from scratch, tiering partnerships, managing
  co-marketing, making build-vs-partner de...
license: MIT
tags:
- general
metadata: None
