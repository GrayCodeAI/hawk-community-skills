---
name: payment-platform-config-recommender
description: "Use to recommend the right payment-platform integration configuration for marketplaces, platforms, and multi-vendor businesses from a company URL or business description."
license: MIT
tags:
- payments
- platforms
