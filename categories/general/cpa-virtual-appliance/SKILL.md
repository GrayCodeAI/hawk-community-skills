---
name: cpa-virtual-appliance
description: "Skill: cpa-virtual-appliance"
license: MIT
tags: [general]
---
...
az network virtual-appliance identity assign

# Remove the user or system managed identities.
az network virtual-appliance identity remove

# Show the details of managed identities.
az network virtual-appliance identity show

# Place the CLI in a waiting state until a condition is met.
az network virtual-appliance identity wait
