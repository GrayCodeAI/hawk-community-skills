...
description: "Use when publishing events reliably — write outbox entries in the same DB transaction as business data and relay them to prevent dual-write failures."
license: MIT
tags:
- outbox
- messaging
