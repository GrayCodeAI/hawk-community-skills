---
name: blockchain-design-patterns
description: "Use when selecting blockchain design patterns: token standards, upgradeable contracts, oracles, bridges, scaling, and MEV-aware design."
license: MIT
tags:
- blockchain
- patterns
