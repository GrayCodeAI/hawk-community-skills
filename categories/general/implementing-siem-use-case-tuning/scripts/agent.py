...
def main():
    ...
    parser.add_argument(
        "--alert-csv", required=True, help="CSV export of SIEM alerts with disposition data"
    )
    parser.add_argument(
        "--fp-threshold",
        type=float,
    ...
    parser.add_argument(
        "--top-rules", type=int, default=5, help="Number of top rules to compute thresholds for"
    )
