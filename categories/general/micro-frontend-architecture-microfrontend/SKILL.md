---
name: micro-frontend-architecture-microfrontend
description: "Use when designing microfrontend architectures with Module Federation, iframes, or Web Components and cross-app communication."
license: MIT
tags:
- microfrontends
- architecture
