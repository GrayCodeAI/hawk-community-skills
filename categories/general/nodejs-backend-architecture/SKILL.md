...
description: "Use to design Node.js backend architecture covering framework selection, project structure, middleware ordering, error handling, and validation."
license: MIT
tags:
- nodejs
- architecture
