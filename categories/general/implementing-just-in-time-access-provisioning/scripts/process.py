...
class JITAccessEngine:
    ...
    def deny_request(self, request_id: str, denier: str, reason: str = "") -> JITAccessRequest:
        ...
        self._log_event("REQUEST_DENIED", request_id, {"denied_by": denier, "reason": reason})
        return request
    ...
    def revoke_access(self, request_id: str, reason: str = "") -> JITAccessRequest:
        ...
        self._log_event(
            "ACCESS_REVOKED",
            request_id,
            {"requester": request.requester, "resource": request.target_resource, "reason": reason},
        )
        return request
...
def main():
    ...
    # Submit requests
    engine.submit_request("alice", "docs-server", "read_only", 30, "Need to check documentation")
