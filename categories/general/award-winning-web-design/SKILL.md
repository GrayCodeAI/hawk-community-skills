...
description: "Use to create immersive, agency-level web experiences; covers dramatic typography, scroll-based motion, custom easing, and performance-optimized animation for memorable sites."
license: MIT
tags:
- web-design
- animation
