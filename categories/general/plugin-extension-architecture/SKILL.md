---
name: plugin-extension-architecture
description: "Use when designing extensible systems — plugin interfaces, extension points, dynamic loading, and lifecycle management."
license: MIT
tags:
- plugins
- extensibility
