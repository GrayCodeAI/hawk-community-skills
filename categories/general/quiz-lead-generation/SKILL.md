...
description: "Use to build quiz and assessment funnels that capture qualified leads; covers concept hooks, scored questions, dynamic tiered results, and segmented follow-up sequences."
license: MIT
tags:
- lead-generation
- quiz
