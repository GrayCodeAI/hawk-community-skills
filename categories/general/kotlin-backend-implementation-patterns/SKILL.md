---
name: kotlin-backend-implementation-patterns
description: "Use when implementing Kotlin backend patterns: repository, service layer, DTO mapping, Koin DI, and MockK testing."
license: MIT
tags:
- kotlin
- backend
