---
name: one-page-marketing-plan
description: "Use to build a complete marketing plan covering the full customer journey from stranger to raving fan using the 9-square grid across before, during, and after phases."
license: MIT
tags:
- marketing-plan
- customer-journey
