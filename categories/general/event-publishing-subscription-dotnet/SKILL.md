---
name: event-publishing-subscription-dotnet
description: "Publish and consume events in .NET with topics, domains, and namespaces using standard and cloud event schemas."
license: MIT
tags:
- event-driven
- messaging
