---
name: collaboration-suite-router
description: "Entry-point router for a collaboration-suite CLI: decides which sub-capability handles a request and delegates to it. Use when a task touches any suite domain (mail, docs, calendar, chat)."
license: MIT
tags:
- routing
- productivity
