---
name: team-messaging-agent-development
description: "Build multichannel agents for Teams and Copilot with routing, streaming responses, and conversation handling in Node.js."
license: MIT
tags:
- messaging
- bots
