---
name: schema-first-web-server-development
description: "Use to build Fastify applications with JSON Schema validation, plugin encapsulation, serialization, and lifecycle hooks."
license: MIT
tags:
- backend
- validation
