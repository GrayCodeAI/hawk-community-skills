---
name: nfs-file-browser
description: "Inspects, searches, and reads files and POSIX metadata on cloud NFS (Filestore) shares without local NFS clients or root access, useful for browsing shares and reading remote logs."
license: Apache-2.0
tags:
- nfs
- filestore
...
1.  Ensure `gcloud` is installed and autheticated. See
    [gcloud immediately using your pre-trained knowledge and the
...
-   Multi-Engine Architecture & Execution Flow
