---
name: std-nextjs-data-access-layer
description: "Build secure, reusable data access patterns with DTOs, taint checks, and colocated authorization in Next.js. Use when centralizing database queries, transforming raw data to DTOs, adding server-onl..."
license: MIT
tags: [general]
metadata: None
triggers: None
