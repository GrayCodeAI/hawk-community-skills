...
description: "Use when writing, debugging, or refactoring JavaScript with ES2023+, async/await, ESM modules, and Node.js — browser APIs, Web Workers, and performance optimization."
license: MIT
tags:
- javascript
- esm
