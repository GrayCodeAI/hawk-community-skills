...
description: "Use when implementing multi-tenant SaaS isolation — row-level, schema-per-tenant, or DB-per-tenant strategies with provisioning, migrations, and cross-tenant security."
license: MIT
tags:
- multi-tenancy
- saas
