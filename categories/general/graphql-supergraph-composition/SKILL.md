---
name: graphql-supergraph-composition
description: "Use when composing multiple GraphQL subgraphs into a unified supergraph — federation directives, entity resolution, and gateway planning."
license: MIT
tags:
- graphql
- federation
...
## References
- GraphQL Federation Fundamentals — Federation v2 core concepts, directives, entity types, subgraph design
- GraphQL Federation Advanced — Advanced topics: cost analysis, contract testing, migration strategies, multi-region
- Entity Resolution — Entity resolution patterns, __resolveReference, @requires, @provides flow
- Federation Architecture — Subgraph design principles, Fed 1 vs Fed 2 comparison
- Federation Deployment — Production deployment, CI/CD, rollback procedures
- Federation Performance — Query planning, caching, DataLoader, performance budgets
- Federation Security — AuthN at router, authZ at subgraph, rate limiting, DoS protection
- Federation Testing — Unit, integration, contract testing patterns
- Supergraph Composition — Composition pipeline, directives, CI/CD
- Supergraph Config — Router configuration, traffic shaping, query plans
- Federation vs Mesh — Apollo Federation vs GraphQL Mesh comparison
- Federated Tracing — OpenTelemetry, Studio integration, distributed tracing
- Federation Migration Monolith — Migrating from monolithic GraphQL to federation (Strangler Fig)
- Federation Cost Management — Cost analysis, demand control, entity resolution cost optimization
