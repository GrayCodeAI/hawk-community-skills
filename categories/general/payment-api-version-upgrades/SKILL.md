---
name: payment-api-version-upgrades
description: "Use when upgrading payment API versions, server-side SDKs, Stripe.js, or mobile SDKs, reviewing breaking vs backward-compatible changes between date-based versions."
license: MIT
tags:
- upgrades
- api-versioning
