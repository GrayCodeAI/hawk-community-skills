---
name: feature-specification-workshop
description: "Use when defining new features or gathering requirements to run structured workshops producing EARS-format specs, user stories, acceptance criteria, and implementation checklists."
license: MIT
tags:
- requirements
- specifications
