---
name: event-streaming-dotnet
description: "Stream high-throughput events in .NET by sending batches and processing with checkpointing, partitions, and buffered producers."
license: MIT
tags:
- event-streaming
- messaging
