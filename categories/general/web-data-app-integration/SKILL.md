---
name: web-data-app-integration
description: "Build web-data capabilities into application code (search, scrape, structured extraction, browser interaction); route requests to the narrowest endpoint for the feature."
license: ISC
tags:
- web-scraping
- web-search
