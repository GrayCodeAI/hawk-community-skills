---
name: implementation-planning-agent-implementation-plan
description: "Use when planning code changes: research the codebase and draft a structured implementation plan with goals, open questions, and verification before writing code."
license: MIT
tags:
- planning
- implementation
