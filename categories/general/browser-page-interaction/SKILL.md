---
name: browser-page-interaction
description: "Use to drive a live browser on a scraped page to click, fill forms, log in, paginate, or scroll when content requires interaction."
license: ISC
tags:
- browser
- automation
...
- firecrawl-search — use `search` for web searches
