...
## Gemini vs Other Tools
- GEMINI.md follows the same general pattern as CLAUDE.md and AGENTS.md: hierarchical, markdown-based, loaded every session
- GitHub Copilot also recognizes GEMINI.md at the repo root as an alternative to its own instruction format
- No override file concept (unlike AGENTS.override.md)
- No frontmatter or metadata — pure markdown content
- Sub-directory scanning is unique: most other tools only walk upward from the current directory, Gemini also scans downward
