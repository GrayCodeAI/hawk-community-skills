...
def run_psort_export(storage_file, output_file, output_format="l2tcsv", date_filter=None):
...
def full_pipeline(image_path, output_dir, parsers=None, start_date=None, end_date=None):
    ...
    if parsers is None:
        parsers = (
            "winevtx,prefetch,mft,usnjrnl,lnk,recycle_bin,chrome_history,firefox_history,winreg"
        )
