---
name: event-publishing-pubsub
description: "Publish and consume events for event-driven pub/sub architectures, routing events between services with the Java Event Grid SDK."
license: MIT
tags:
- event-driven
- messaging
