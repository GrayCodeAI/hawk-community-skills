...
description: "Use for any live-web research via a web CLI: searching, reading or extracting pages, discovering site URLs, bulk extraction, downloading a site, or setting change alerts."
license: ISC
tags:
- web-scraping
- research
