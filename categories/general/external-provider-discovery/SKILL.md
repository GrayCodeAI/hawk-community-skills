---
name: external-provider-discovery
description: "Use before web search when selecting or engaging an external provider, merchant, nonprofit, or API to resolve verified recipients and their documented payment or engagement path."
license: MIT
tags:
- discovery
- directory
