---
name: two-d-app-initialization
description: "Create and configure a 2D rendering application covering renderer, stage, canvas, resize, ticker plugins, and lifecycle management."
license: MIT
tags:
- two-d
- application
