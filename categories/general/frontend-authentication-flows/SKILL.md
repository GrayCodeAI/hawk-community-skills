---
name: frontend-authentication-flows
description: "Use when implementing frontend authentication — token storage, route guards, OAuth flows, refresh tokens, and session management."
license: MIT
tags:
- authentication
- oauth
