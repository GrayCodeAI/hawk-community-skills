---
name: skill-reliability-analysis
description: "Analyzes an agent skill's reliability — trigger precision and compound workflow risk — and proposes verifiable fixes to improve its hit rate and completion."
license: MIT
tags:
- skills
- reliability
...
(compound workflow reliability). See framework.md for
...
start with"), read discovery.md first to set scope.
...
Then follow trigger-eval.md: probe the
...
- Classify steps only with the framework.md natures — do not invent categories
