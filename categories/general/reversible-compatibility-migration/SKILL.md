---
name: reversible-compatibility-migration
description: "Implement reversible compatibility-safe transitions for schema, data, API, or config migrations requiring rollback and preservation proof."
license: MIT
tags:
- migration
- rollback
