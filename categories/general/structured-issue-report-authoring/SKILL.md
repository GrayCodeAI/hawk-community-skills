---
name: structured-issue-report-authoring
description: "Convert raw notes, error logs, or dictation into crisp, structured markdown issue reports with reproduction steps and evidence."
license: MIT
tags:
- issues
- markdown
