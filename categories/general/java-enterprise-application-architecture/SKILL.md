---
name: java-enterprise-application-architecture
description: "Use when structuring Spring Boot apps: package-by-feature, hexagonal architecture, ports/adapters, and DI."
license: MIT
tags:
- java
- backend
