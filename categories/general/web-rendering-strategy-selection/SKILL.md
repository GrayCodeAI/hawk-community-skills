---
name: web-rendering-strategy-selection
description: "Use when choosing per-route rendering — CSR, SSR, SSG, ISR, or RSC — based on SEO, data freshness, and interactivity needs."
license: MIT
tags:
- rendering
- ssr
