---
name: windows-forms-desktop-development
description: "Use to build and maintain Windows desktop apps with Windows Forms, data-bound controls, layout, validation, and GDI+ drawing."
license: MIT
tags:
- windows
- desktop
