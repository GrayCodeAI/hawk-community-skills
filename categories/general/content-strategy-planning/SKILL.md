...
description: "Use to plan a content strategy, decide topics, and build searchable or shareable content that drives traffic and leads."
license: MIT
tags:
- content-marketing
- seo
...
- **Content Distribution Spine**: Create Once Distribute Twice, ORB as a funnel, the ownership paradox, platform half-lives, the Content Distribution Flywheel, and the per-flagship atomization checklist
