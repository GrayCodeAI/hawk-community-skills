---
name: lightweight-react-compatible-ui
description: "Use when building ultra-lightweight Preact apps with signals, hooks, and the compat layer for React interop."
license: MIT
tags:
- preact
- signals
