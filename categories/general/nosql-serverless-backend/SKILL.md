---
name: nosql-serverless-backend
description: "Use when building a serverless backend with a NoSQL document store — data modeling, security rules, auth, cloud functions, storage."
license: MIT
tags:
- nosql
- serverless
