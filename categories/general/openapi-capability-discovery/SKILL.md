---
name: openapi-capability-discovery
description: "Discover and explore the OpenAPI surface of a collaboration-suite CLI: list resources, methods, parameters, and schemas. Use when a user wants to find or understand an available API capability."
license: MIT
tags:
- openapi
- api
