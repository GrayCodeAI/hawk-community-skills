...
description: "Build and maintain a reusable design system in an Expo app with theme design tokens for color, spacing, typography, radius, shadow, and motion, plus reusable component conventions."
license: MIT
tags:
- design-system
- design-tokens
