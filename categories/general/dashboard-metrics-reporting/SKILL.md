---
name: dashboard-metrics-reporting
description: "Use to pull metrics from analytics dashboards and internal web tools, producing cross-platform metric summaries and date-range reports."
license: ISC
tags:
- analytics
- dashboards
