---
name: fluid-interface-design
description: "Apply Apple's approach to fluid, physical interface design on the web — springs, gestures, interruptible motion, translucency, typography, and design principles."
license: MIT
tags:
- design
- animation
