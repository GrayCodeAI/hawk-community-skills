...
description: "Use when building Laravel 10+ applications — Eloquent models, Sanctum auth, Horizon queues, API resources, Livewire components, and Pest/PHPUnit tests."
license: MIT
tags:
- laravel
- php
