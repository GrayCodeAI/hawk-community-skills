---
name: copilot-scaffolding-oracle-to-postgres-migration-test-project
description: "Scaffolds an xUnit integration test project for validating Oracle-to-PostgreSQL database migration behavior in .NET solutions. Creates the test project, transaction-rollback base class, and seed da..."
license: MIT
tags: [general]
---
