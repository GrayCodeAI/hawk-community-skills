---
name: node-runtime-best-practices
description: "Use when developing Node.js apps with TypeScript — type stripping, async, error handling, streams, testing, performance, caching, logging, and graceful shutdown."
license: MIT
tags:
- node
- javascript
