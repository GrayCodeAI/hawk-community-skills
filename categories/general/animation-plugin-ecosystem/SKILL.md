---
name: animation-plugin-ecosystem
description: "Apply animation plugins for scroll-to, flip, draggable, SVG morphing, text splitting, physics, and custom easing across web animation projects."
license: MIT
tags:
- animation
- plugins
