---
name: embedded-cpp-memory-patterns
description: "Apply C/C++ embedded patterns: memory alignment, RAII resource management, and pointer arithmetic for hardware programming."
license: MIT
tags:
- embedded
- cpp
