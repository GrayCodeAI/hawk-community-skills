...
description: "Use to find co-marketing partners and plan joint campaigns, webinars, content, and integration marketing with complementary brands."
license: MIT
tags:
- partnerships
- co-marketing
...
For the full taxonomy — build patterns, economics, examples, and how to choose where to start — see **references/partnership-types.md**. (Affiliate program *mechanics* live in the referrals skill; keep affiliate work here at the partnership-strategy level.)
