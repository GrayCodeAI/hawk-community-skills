...
description: "Coordinate supervised multi-agent workflows with threaded messages, task dispatch, worker waits, task DAGs, decision gates, and coordinator loops."
license: MIT
tags:
- orchestration
- multi-agent
