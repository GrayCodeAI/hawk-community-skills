...
description: "Use when building a blockchain dapp, writing on-chain programs, creating tokens, debugging chain errors, setting up wallet connection, testing, or deploying to a test network."
license: MIT
tags:
- blockchain
- web3
...
- **Transaction v1 / larger transactions (SIMD-0385):** transactions-v1.md — feature gate check, `maxSupportedTransactionVersion: 1`, `transactionConfig`, sending with kit 8
...
- Program design patterns (state layout, PDAs, parallelization, cranks, ergonomics): programs/design-patterns.md
- Runtime concepts (rent, off-curve PDAs, entrypoint dispatch, wire format): concepts.md
...
- **Surfpool Kit plugin (`@solana/surfpool/kit`):** surfpool/kit-plugin.md — embedded surfnet behind a Kit client, typed cheatcodes
