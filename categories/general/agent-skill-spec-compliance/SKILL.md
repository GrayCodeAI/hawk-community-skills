---
name: agent-skill-spec-compliance
description: "Evaluate any Agent Skill against the official specification and best practices, checking frontmatter compliance, structure, progressive disclosure, script safety, and security."
license: Apache-2.0
tags:
- agent-skills
- compliance
...
3. **Treat the rubric as the ground truth**. If references/official-rubric.md says a check is "Should", do not report it as a hard failure.
