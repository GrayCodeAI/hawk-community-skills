---
name: dotnet-microservice-development
description: "Use when building .NET 8 applications with minimal APIs, clean architecture, or cloud-native microservices — Entity Framework Core, CQRS with MediatR, and JWT auth."
license: MIT
tags:
- dotnet
- csharp
