---
name: multi-tenant-saas-architecture-multi-tenant
description: "Use when designing multi-tenant SaaS architectures with tenant isolation, lifecycle management, and data boundaries."
license: MIT
tags:
- multi-tenant
- saas
