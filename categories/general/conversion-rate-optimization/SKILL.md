...
description: "Use when a landing page or funnel isn't converting; research why visitors leave, map the funnel, build objection and counter tables, and design evidence-based A/B tests."
license: MIT
tags:
- conversion
- a-b-testing
