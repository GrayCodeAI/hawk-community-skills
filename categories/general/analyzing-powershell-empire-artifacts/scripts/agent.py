...
EMPIRE_LAUNCHER_PATTERN = re.compile(r"powershell\s+-noP\s+-sta\s+-w\s+1\s+-enc\s+", re.IGNORECASE)
...
def main():
    ...
    scan_parser.add_argument(
        "--max-events", type=int, default=1000, help="Max events to query (default: 1000)"
    )
