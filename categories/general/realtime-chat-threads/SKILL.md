---
name: realtime-chat-threads
description: "Build real-time chat with threads, messaging, participants, read receipts, and typing notifications using the Java Chat SDK."
license: MIT
tags:
- chat
- messaging
