---
name: cross-platform-bot-migration
description: "Migrate Slack bots to Teams and build dual-platform bots, converting Block Kit to Adaptive Cards and bridging identity, events, and OAuth."
license: MIT
tags:
- bots
- migration
