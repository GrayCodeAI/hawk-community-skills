...
description: "Use when designing distributed systems, decomposing monoliths, choosing service boundaries, DDD, sagas, event sourcing, CQRS, resilience, or distributed tracing."
license: MIT
tags:
- microservices
- distributed-systems
