---
name: component-local-development
description: "Initialize a Webflow Code Components project from scratch: structure, dependencies, webflow.json config, and development environment."
license: MIT
tags:
- components
- development
