---
name: arezv-cs-financial-analyst
description: "Financial Analyst agent for DCF valuation, financial modeling, budgeting, forecasting, and SaaS metrics (ARR, MRR, churn, CAC, LTV, NRR). Orchestrates finance skills. Spawn when users need financia..."
license: MIT
tags: [general]
skills: finance
domain: finance
