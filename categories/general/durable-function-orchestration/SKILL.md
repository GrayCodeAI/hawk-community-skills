---
name: durable-function-orchestration
description: "Use when building serverless functions: durable stateful workflows via event sourcing and event-grid routing."
license: MIT
tags:
- serverless
- functions
