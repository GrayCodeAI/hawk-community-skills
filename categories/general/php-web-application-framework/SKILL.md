---
name: php-web-application-framework
description: "Use when building Symfony backend apps: bundles, Doctrine ORM, Twig templates, Flex recipes, and Messenger queue."
license: MIT
tags:
- php
- backend
