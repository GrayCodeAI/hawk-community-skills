...
description: "Use when diagnosing slow sites, optimizing Core Web Vitals, HTTP/2-3, resource hints, caching, or real-time transports to cut latency and round trips."
license: MIT
tags:
- performance
- core-web-vitals
