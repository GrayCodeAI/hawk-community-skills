---
name: nodejs-runtime-patterns
description: "Use to implement production-grade Node.js patterns: streams with backpressure, typed event emitters, worker threads, DI, and error handling."
license: MIT
tags:
- nodejs
- streams
