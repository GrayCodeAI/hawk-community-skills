---
name: multichannel-agent-development-dotnet
description: "Build multichannel enterprise agents for messaging platforms with ASP.NET Core hosting, routing, and token-based authentication."
license: MIT
tags:
- agents
- messaging
