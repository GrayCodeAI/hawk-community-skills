---
name: declarative-macos-app-development
description: "Use to build native macOS apps with SwiftUI using scenes, navigation split views, state management, commands, and SwiftData."
license: MIT
tags:
- macos
- desktop
