---
name: advertising-account-diagnostics
description: "Diagnose advertising account performance issues such as conversion loss, low lead flow, and lost impression share due to rank, bids, or budgets. Use when troubleshooting sudden performance drops."
license: Apache-2.0
tags:
- advertising
- diagnostics
