---
name: standup-report-generation
description: "Generate a daily standup or status report by aggregating a user's recent activity, tasks, and updates across a collaboration suite. Use when a user asks for a daily summary of their work."
license: MIT
tags:
- standup
- reporting
