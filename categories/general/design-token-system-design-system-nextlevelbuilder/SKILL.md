---
name: design-token-system-design-system-nextlevelbuilder
description: "Defines three-layer design token architecture, CSS variables, component specs, and brand-compliant slide generation."
license: MIT
tags:
- design-system
- tokens
