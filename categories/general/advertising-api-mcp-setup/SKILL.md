---
name: advertising-api-mcp-setup
description: "Download, configure, and install an MCP server to connect an AI assistant to an advertising account for natural-language queries. Use when connecting an assistant to query campaigns."
license: Apache-2.0
tags:
- mcp
- api
