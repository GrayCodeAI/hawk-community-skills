---
name: mobile-development-overview
description: "Entry point for any Expo or EAS task that classifies a goal and routes to the correct specialist skill, covering shared setup rules like SDK detection and package installation."
license: MIT
tags:
- mobile
- overview
