---
name: linux-desktop-app-development
description: "Use to build GNOME applications and shell extensions with libadwaita, GSettings, GIO, and Flatpak distribution following the GNOME HIG."
license: MIT
tags:
- linux
- desktop
