---
name: skill-feedback-submission
description: "Submit actionable feedback on an Expo skill or Expo itself, report eval candidates for tasks that broke an agent, and control bundled anonymous usage telemetry."
license: MIT
tags:
- feedback
- telemetry
