---
name: ghcp-vertical-scaling-skill
...
- Monitor actual usage via Grafana/Prometheus before and after resizing [Monitoring](SKILL.md)
...
When you hit these limits, see [Horizontal Scaling](SKILL.md) for guidance on sharding and node planning.
