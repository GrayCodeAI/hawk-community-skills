---
name: payment-integration-guidance
description: "Use when building or reviewing payment integrations to choose the right API, and configure Connect, billing, tax, and security, and migrate from deprecated APIs."
license: MIT
tags:
- payments
- integration
