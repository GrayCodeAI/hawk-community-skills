---
name: operating-system-kernel-internals
description: "Use when learning OS internals: protection rings, monolithic vs microkernel architecture, and hardware privilege levels."
license: MIT
tags:
- kernel
- operating-system
