---
name: website-design-extraction
description: "Use to extract a website's colors, fonts, spacing, components, and layout patterns into an agent-ready DESIGN.md for cloning or building inspired pages."
license: ISC
tags:
- design-system
- ui
