---
name: ui-design-system-refactoring
description: "Use when a web UI looks amateur or off; audit and fix visual hierarchy, spacing scales, color palettes, shadows, and design tokens using a grayscale-first systematic approach."
license: MIT
tags:
- ui-design
- visual-hierarchy
