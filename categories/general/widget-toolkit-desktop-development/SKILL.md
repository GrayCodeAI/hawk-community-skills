---
name: widget-toolkit-desktop-development
description: "Use to build applications with GTK (GTK3/GTK4) using widget hierarchies, CSS styling, GtkBuilder UI files, and signal handling."
license: MIT
tags:
- linux
- desktop
