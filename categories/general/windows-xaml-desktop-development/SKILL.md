---
name: windows-xaml-desktop-development
description: "Use to build Windows desktop apps with WPF using XAML, MVVM, data binding, commands, styles, and custom controls."
license: MIT
tags:
- windows
- desktop
