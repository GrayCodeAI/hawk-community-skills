---
name: mobile-data-fetching
description: "Implement or debug any network request or API call in an Expo app, covering fetch, React Query, SWR, error handling, caching, offline support, and route data loaders."
license: MIT
tags:
- networking
- api
