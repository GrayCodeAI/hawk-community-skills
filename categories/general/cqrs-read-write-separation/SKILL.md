---
name: cqrs-read-write-separation
description: "Use when separating read and write models — commands for consistency, queries for performance, and eventual consistency between them."
license: MIT
tags:
- cqrs
- architecture
