---
name: animation-codebase-audit
description: "Audit a codebase's animation and motion code as a senior advisor and produce prioritized findings plus self-contained implementation plans for other agents to execute."
license: MIT
tags:
- animation
- motion
