---
name: worktree-terminal-control
description: "Operate managed worktrees, folder contexts, terminals, repos, automations, artifacts, and an embedded browser via a CLI for agent handoffs and terminal control."
license: MIT
tags:
- worktree
- terminal
