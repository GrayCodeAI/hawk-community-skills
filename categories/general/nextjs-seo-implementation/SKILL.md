---
name: nextjs-seo-implementation
description: "Implement crawlability, metadata, canonicals, structured data, and crawler policy in a Next.js app; use when asked to fix SEO or add a sitemap."
license: MIT
tags:
- seo
- nextjs
