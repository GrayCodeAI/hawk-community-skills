---
name: ghcp-scaling-qps-skill
description: "Guides Qdrant query throughput (QPS) scaling. Use when someone asks 'how to increase QPS', 'need more throughput', 'queries per second too low', 'batch search', 'read replicas', or 'how to handle m..."
license: MIT
tags: [general]
---
...
See also [Horizontal Scaling](SKILL.md) for general horizontal scaling guidance.
