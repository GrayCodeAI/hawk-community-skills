---
name: lit-web-component-development
description: "Use when building standard web components with Lit — reactive properties, shadow DOM templates, typed events, and SSR."
license: MIT
tags:
- web-components
- lit
