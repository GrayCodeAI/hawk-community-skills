---
name: readonly-code-localization
description: "Fast read-only repository explorer returning path:line citations; use for cold-start orientation or when a direct search failed."
license: MIT
tags:
- code-search
- localization
