---
name: terse-communication-mode-reference
description: "Quick-reference card for terse communication modes, skills, and commands; display on request without changing state."
license: MIT
tags:
- communication
- reference
