---
name: react-video-migration
description: "Port an existing React-based video composition's source into an HTML video framework, one-way. Use only when a user explicitly asks to migrate or translate a React video project."
license: Apache-2.0
tags:
- migration
- video
