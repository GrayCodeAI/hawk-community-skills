---
name: agc-interface-design
description: "Skill: agc-interface-design"
license: MIT
tags: [general]
---
...
Include both LANGUAGE.md vocabulary and the project's own domain vocabulary in the brief so each sub-agent names things consistently with the architecture language and whatever terminology the project already uses (from a glossary file if one exists, otherwise from dominant names in the code).
