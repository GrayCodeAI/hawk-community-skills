---
name: recurring-marketing-automation
description: "Set up recurring, self-running marketing workflows an AI agent runs on a cadence — weekly reviews, ad-fatigue checks, churn watches, and ranking-drop alerts with defined triggers and stop conditions."
license: MIT
tags:
- marketing
- automation
