---
name: web-page-interaction-integration
description: "Integrate page interaction (clicks, form fills, pagination, multi-step flows) into app code when scraping alone cannot reach dynamic or gated content."
license: ISC
tags:
- browser-automation
- web-scraping
