---
name: modern-cpp-systems-development
description: "Use when writing, optimizing, or debugging modern C++20/23 — concepts, ranges, templates, RAII, SIMD, concurrency, memory management, and CMake build configuration."
license: MIT
tags:
- cpp
- performance
