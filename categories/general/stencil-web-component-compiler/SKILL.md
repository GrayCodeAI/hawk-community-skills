---
name: stencil-web-component-compiler
description: "Use when building reusable framework-agnostic web components with Stencil decorators, JSX, and lazy loading."
license: MIT
tags:
- web-components
- stencil
