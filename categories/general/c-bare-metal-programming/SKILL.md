---
name: c-bare-metal-programming
description: "Use when working on C systems or bare-metal programming, covering pointers, volatile, undefined behavior, and low-level memory control."
license: MIT
tags:
- c
- systems
