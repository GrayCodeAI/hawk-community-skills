...
description: "Design and optimize revenue operations: lead lifecycle stages, scoring, routing, pipeline management, and CRM automation that connect marketing to sales."
license: MIT
tags:
- revenue-operations
- crm
