---
name: spec-implementation-orchestration
description: "Implement a specification by working its ticket task graph with parallel background implementer subagents, merging work into one PR branch."
license: MIT
tags:
- implementation
- tickets
