---
name: dotnet-csharp-web-development
description: "Use when building C# apps with .NET 8+, ASP.NET Core APIs, or Blazor — minimal/controller routing, EF Core, async patterns, CQRS with MediatR, and state management."
license: MIT
tags:
- csharp
- dotnet
