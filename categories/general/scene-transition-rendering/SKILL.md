---
name: scene-transition-rendering
description: "Render-correctness doctrine for scene-to-scene transitions in animated video: stage ground, wrapper overlap, master-timeline mechanics. Use when assembling a master timeline or fixing seam flashes."
license: Apache-2.0
tags:
- animation
- transitions
