---
name: embedded-video-captions
description: "Add captions or subtitles to an existing talking-head video without editing footage, using a rail-plus-embed caption model. Use when a user wants captions on a single-subject clip."
license: Apache-2.0
tags:
- captions
- video
...
| dna/README.md                                           | **The DNA registry** — ten scene-parameterized visual languages; how to pick.                                                      |
