...
def main():
    ...
    parser.add_argument(
        "--rules", required=True, help="JSON file with detection rules and ATT&CK mappings"
    )
    ...
    attack_matrix = (
        load_attack_matrix(args.matrix) if args.matrix else {t: [] for t in ENTERPRISE_TACTICS}
    )
