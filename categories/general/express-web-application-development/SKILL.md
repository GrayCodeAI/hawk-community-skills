---
name: express-web-application-development
description: "Use to structure Express.js apps with clean middleware pipelines, routing, global error handling, and schema validation."
license: MIT
tags:
- backend
- http
