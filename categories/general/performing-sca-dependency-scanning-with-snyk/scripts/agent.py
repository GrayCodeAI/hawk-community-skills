...
def apply_quality_gate(findings: list[dict], max_critical: int = 0, max_high: int = 5) -> dict:
...
def main():
    ...
    parser.add_argument(
        "--max-critical", type=int, default=0, help="Max critical vulns for quality gate"
    )
