...
description: "Implement event and conversion ingestion to advertising and analytics products via a data manager API and client libraries. Use when uploading offline conversions or enhanced conversions for leads."
license: Apache-2.0
tags:
- data-ingestion
- api
