---
name: incremental-implementation-method
description: "Use when implementing any multi-file feature — build in thin vertical slices, test and verify each increment before expanding, keeping the system working."
license: MIT
tags:
- workflow
- incremental
