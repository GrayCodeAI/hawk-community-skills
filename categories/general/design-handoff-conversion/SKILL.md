---
name: design-handoff-conversion
description: "Translate Figma designs into live Webflow pages and sections with native elements, styles, assets, and fonts."
license: MIT
tags:
- design
- ui
...
Before handling images or vectors, read Assets and SVG.
...
If the build includes a navbar, read Navbar before building it.
