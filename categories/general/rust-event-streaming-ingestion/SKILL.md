---
name: rust-event-streaming-ingestion
description: "Send and receive streaming events in Rust with batched producers and partitioned consumers for high-throughput ingestion."
license: MIT
tags:
- event-streaming
- real-time
