---
name: ghcp-agents-ai-team-producer.agent
description: "AI team producer agent (Remy). Use when: planning sprints, creating PROJECT_BRIEF.md, triaging bugs, merging PRs, coordinating between dev and QA teams, filing GitHub Issues, writing sprint plans, ..."
license: MIT
tags: [general]
