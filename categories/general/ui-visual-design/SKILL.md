...
description: "Guidance for distinctive, intentional visual design when building new UI or reshaping existing one — palette, typography, and layout choices that avoid templated AI-generated defaults."
license: MIT
tags:
- ui
- visual-design
