---
name: edge-ready-web-framework-development
description: "Use to build lightweight, edge-ready web applications with Hono, Zod validation, RPC type-safe clients, and cross-runtime support."
license: MIT
tags:
- backend
- edge
