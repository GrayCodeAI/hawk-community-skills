...
description: "Fetch design context, screenshots, and assets from a design tool via MCP and translate design nodes into production code matching project conventions."
license: MIT
tags:
- design
- design-to-code
