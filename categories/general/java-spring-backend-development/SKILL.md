---
name: java-spring-backend-development
description: "Use when building Spring Boot 3.x Java apps — REST controllers, Spring Data JPA, Spring Security 6, WebFlux, microservices, and testing."
license: MIT
tags:
- java
- spring
