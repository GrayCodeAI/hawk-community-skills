...
def main():
    parser = argparse.ArgumentParser(description="Detect T1548 Abuse Elevation Control Mechanism")
    ...
    report["risk_level"] = (
        "CRITICAL" if total >= 5 else "HIGH" if total >= 2 else "MEDIUM" if total > 0 else "LOW"
    )
