---
name: skill-awesome-authoring
description: "Author Agent Skills against the official spec: naming, frontmatter, directory structure, progressive disclosure, description triggering, and script safety best practices."
license: Apache-2.0
tags:
- agent-skills
- skill-design
...
For a complete example of what an awesome list looks like, see examples/sample-awesome.md.
