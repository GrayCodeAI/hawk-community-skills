---
name: project-skill-orchestrator
description: "Use at project start to route to the correct next skill: inspects filesystem state and directs to the appropriate workflow skill."
license: MIT
tags:
- orchestration
- routing
