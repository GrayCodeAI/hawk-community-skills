---
name: enterprise-messaging-dotnet
description: "Build reliable enterprise messaging in .NET using queues, topics, subscriptions, sessions, and dead-letter handling with the Service Bus SDK."
license: MIT
tags:
- messaging
- queue
