---
name: kotlin-server-application-architecture
description: "Use when designing Kotlin backend architecture with Ktor, coroutine pipelines, routing, error handling, and DI."
license: MIT
tags:
- kotlin
- backend
