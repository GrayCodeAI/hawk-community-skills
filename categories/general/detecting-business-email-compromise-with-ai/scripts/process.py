...
def detect_bec_ai(email_data: dict, baseline: dict = None, vip_list: list = None) -> BECAIResult:
    ...
    # Behavioral analysis
    if baseline:
        result.behavioral_score, beh_indicators = compute_behavioral_score(email_data, baseline)
