---
name: ghcp-gtm-product-led-growth-skill
description: Build self-serve acquisition and expansion motions. Use when deciding
  PLG vs sales-led, optimizing activation, driving freemium conversion, building growth
  equations, or recognizing when product co...
license: MIT
tags:
- general
metadata: None
