---
name: assistant-app-development
description: "Scaffold, build, and troubleshoot assistant app SDK applications that combine an MCP server with a widget UI, using a docs-first workflow."
license: MIT
tags:
- mcp
- widgets
