---
name: oversized-cursor-motion
description: "Technique for a large on-screen cursor that carries the viewer's eye, triggers clicks, and ignites transitions in animated video scenes. Use when a scene involves cursor or pointer action."
license: Apache-2.0
tags:
- animation
- cursor
