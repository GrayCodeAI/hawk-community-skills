---
name: okr-goal-management
description: "Manage objectives and key results through a suite CLI: create, update, and track OKRs and align goals across teams. Use when a user wants to set or review objectives."
license: MIT
tags:
- okr
- goals
...
| `+comment-detail`       | 获取周期下 Cycle/Objective/KeyResult/Progress 的全部评论                                                      |
| `+comment-list`           | 分页获取单个 OKR 实体下的评论                                                                                 |
| `+comment-get`             | 获取单条评论详情                                                                                              |
| `+comment-create`       | 创建新评论或回复已有评论(仅支持 --as user)                                                                    |
| `+comment-patch`         | 修改评论内容(仅支持 --as user)                                                                                |
| `+comment-delete`       | 永久删除单条评论(仅支持 --as user)                                                                            |
| `+comment-solve`  | 解决评论或划词评论串(仅支持 --as user)                                                                        |
| `+comment-reopen` | 重新打开评论或划词评论串(仅支持 --as user)                                                                    |
...
- `ContentBlock 富文本格式` — Objective/KeyResult/Progress 中 Content/Note
...
- 待办任务管理 → 使用 `lark-task`
- 日程安排 → 使用 `lark-calendar`
- 绩效评估 → 使用 `lark-openapi-explorer` 查找原生接口
