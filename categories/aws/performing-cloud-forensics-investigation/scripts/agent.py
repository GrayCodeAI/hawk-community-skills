            ...
            suspicious.append(
                {
                    **event,
                    ...
                    "severity": "HIGH"
                    if event_name
                    in ("StopLogging", "DeleteTrail", "CreateAccessKey", "AttachUserPolicy")
                    else "MEDIUM",
                }
            )
            ...
            result["access_keys"].append(
                {
                    ...
                    "last_used": str(
                        last_used.get("AccessKeyLastUsed", {}).get("LastUsedDate", "Never")
                    ),
...
if __name__ == "__main__":
    ...
    with open(output, "w") as f:
        json.dump(
            {"events": events, "suspicious": suspicious, "snapshots": snapshots, "iam": iam_data},
            f,
            indent=2,
        )
