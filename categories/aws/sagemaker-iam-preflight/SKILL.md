...
description: "Ensure a usable SageMaker execution role exists before deploying or training, discovering and validating existing roles before creating one to avoid SSO IAM failures."
license: Apache-2.0
tags:
- sagemaker
- iam
