...
description: "Plan a model deployment to Amazon SageMaker, selecting the right pathway (real-time, serverless, async, batch) and serving stack based on model type and traffic shape."
license: Apache-2.0
tags:
- sagemaker
- aws
