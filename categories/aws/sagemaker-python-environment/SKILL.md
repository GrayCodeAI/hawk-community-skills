---
name: sagemaker-python-environment
description: "Set up an isolated Python environment with the right version and current boto3 for SageMaker and AWS automation, avoiding system Python and dependency conflicts."
license: Apache-2.0
tags:
- python
- aws
