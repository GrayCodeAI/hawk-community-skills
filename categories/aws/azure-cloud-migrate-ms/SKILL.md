---
name: azure-cloud-migrate-ms
description: "Assess and migrate cross-cloud workloads to Azure. Generates assessment reports and converts code from AWS, GCP, or other providers to Azure services. WHEN: migrate Lambda to Azure Functions, migra..."
license: MIT
tags: [aws]
metadata: None
author: Microsoft
