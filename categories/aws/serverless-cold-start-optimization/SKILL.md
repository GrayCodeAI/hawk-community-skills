---
name: serverless-cold-start-optimization
description: "Use when optimizing serverless cold starts: microVM lifecycle, provisioned concurrency, init-phase refactoring, and runtime selection."
license: MIT
tags:
- serverless
- lambda
