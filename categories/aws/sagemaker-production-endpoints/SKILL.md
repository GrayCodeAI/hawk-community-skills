---
name: sagemaker-production-endpoints
description: "Create SageMaker endpoints (real-time, scale-to-zero, or async) with autoscaling, CloudWatch alarms, and tagging by default, then smoke-test them."
license: Apache-2.0
tags:
- sagemaker
- aws
