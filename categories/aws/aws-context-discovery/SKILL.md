...
description: "Discover the user's local AWS context—active profile, region, account ID, and caller identity—before any AWS work, surfacing SSO limitations early."
license: Apache-2.0
tags:
- aws
- configuration
