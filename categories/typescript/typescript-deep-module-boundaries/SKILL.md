---
name: typescript-deep-module-boundaries
description: "Wire dependency-cruiser into a TypeScript repo so each package is a deep module, hiding implementation in subfolders and exposing only root entry points."
license: MIT
tags:
- typescript
- architecture
