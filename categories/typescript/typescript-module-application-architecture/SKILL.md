---
name: typescript-module-application-architecture
description: "Use when structuring NestJS apps: module-based architecture, DI, provider scopes, dynamic modules, and monorepos."
license: MIT
tags:
- typescript
- backend
