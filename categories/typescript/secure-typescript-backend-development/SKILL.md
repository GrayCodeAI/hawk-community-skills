---
name: secure-typescript-backend-development
description: "Use to build secure-by-default TypeScript backends with the Deno runtime covering permissions, modules, Fresh, and deployment."
license: MIT
tags:
- typescript
- runtime
