---
name: javascript-runtime-backend-development
description: "Use when building with the Bun runtime: built-in APIs, test runner, package management, shell scripting, and SQLite."
license: MIT
tags:
- javascript
- typescript
