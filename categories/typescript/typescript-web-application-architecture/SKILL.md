---
name: typescript-web-application-architecture
description: "Use when structuring Elysia.js apps: plugin architecture, lifecycle hooks, type-safe schemas, and Eden Treaty clients."
license: MIT
tags:
- typescript
- backend
