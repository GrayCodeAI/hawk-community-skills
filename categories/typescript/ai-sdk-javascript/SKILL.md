---
name: ai-sdk-javascript
description: "Use the JavaScript/TypeScript SDK to run AI apps, build agents with tools, upload files, and manage sessions in Node or browsers."
license: MIT
tags:
- javascript
- typescript
