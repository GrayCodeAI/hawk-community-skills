---
name: typescript-web-framework-patterns
description: "Use when implementing Elysia.js patterns: Eden Treaty clients, WebSocket handlers, guard macros, plugins, and validation."
license: MIT
tags:
- typescript
- backend
