---
name: typesafe-frontend-patterns
description: "Use when writing type-safe frontend code with generic components, discriminated unions, type guards, and typed API clients."
license: MIT
tags:
- typescript
- types
